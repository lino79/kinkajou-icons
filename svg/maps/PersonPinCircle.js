define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.PersonPinCircle = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PersonPinCircle, _SvgIcon);

    function PersonPinCircle() {
      _classCallCheck(this, PersonPinCircle);

      return _possibleConstructorReturn(this, _getPrototypeOf(PersonPinCircle).apply(this, arguments));
    }

    _createClass(PersonPinCircle, [{
      key: "renderSVG",
  ...
  _exports.PersonPinCircle = PersonPinCircle;
});
//# sourceMappingURL=PersonPinCircle.js.map