define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LocalCafe, _SvgIcon);

    function LocalCafe() {
      _classCallCheck(this, LocalCafe);

      return _possibleConstructorReturn(this, _getPrototypeOf(LocalCafe).apply(this, arguments));
    }

    _createClass(LocalCafe, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.maps.LocalCafe';
      }
    }]);
  ...
  _exports.LocalCafe = LocalCafe;
});
//# sourceMappingURL=LocalCafe.js.map