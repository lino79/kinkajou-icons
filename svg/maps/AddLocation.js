define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AddLocation, _SvgIcon);

    function AddLocation() {
      _classCallCheck(this, AddLocation);

      return _possibleConstructorReturn(this, _getPrototypeOf(AddLocation).apply(this, arguments));
    }
    ...
    _createClass(AddLocation, [{
      ...
      key: "is",
      get: function get() {
        return 'material.maps.AddLocation';
      }
    }]);
  ...
  _exports.AddLocation = AddLocation;
});
