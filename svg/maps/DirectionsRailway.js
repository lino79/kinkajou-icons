define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.DirectionsRailway = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(DirectionsRailway, _SvgIcon);

    function DirectionsRailway() {
      _classCallCheck(this, DirectionsRailway);

      return _possibleConstructorReturn(this, _getPrototypeOf(DirectionsRailway).apply(this, arguments));
    }

    _createClass(DirectionsRailway, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.maps.DirectionsRailway';
      }
    }]);
  ...
  _exports.DirectionsRailway = DirectionsRailway;
});
//# sourceMappingURL=DirectionsRailway.js.map