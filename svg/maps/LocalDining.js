define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LocalDining, _SvgIcon);

    function LocalDining() {
      _classCallCheck(this, LocalDining);

      return _possibleConstructorReturn(this, _getPrototypeOf(LocalDining).apply(this, arguments));
    }

    _createClass(LocalDining, [{
      key: "renderSVG",
  ...
  _exports.LocalDining = LocalDining;
});
//# sourceMappingURL=LocalDining.js.map