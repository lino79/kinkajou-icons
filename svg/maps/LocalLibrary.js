define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LocalLibrary, _SvgIcon);

    function LocalLibrary() {
      _classCallCheck(this, LocalLibrary);

      return _possibleConstructorReturn(this, _getPrototypeOf(LocalLibrary).apply(this, arguments));
    }

    _createClass(LocalLibrary, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.maps.LocalLibrary';
      }
    }]);
  ...
  _exports.LocalLibrary = LocalLibrary;
});
