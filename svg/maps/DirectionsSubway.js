define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.DirectionsSubway = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(DirectionsSubway, _SvgIcon);

    function DirectionsSubway() {
      _classCallCheck(this, DirectionsSubway);

      return _possibleConstructorReturn(this, _getPrototypeOf(DirectionsSubway).apply(this, arguments));
    }

    _createClass(DirectionsSubway, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.maps.DirectionsSubway';
      }
    }]);
  ...
  _exports.DirectionsSubway = DirectionsSubway;
});
//# sourceMappingURL=DirectionsSubway.js.map