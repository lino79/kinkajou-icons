define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LocalActivity, _SvgIcon);

    function LocalActivity() {
      _classCallCheck(this, LocalActivity);

      return _possibleConstructorReturn(this, _getPrototypeOf(LocalActivity).apply(this, arguments));
    }

    _createClass(LocalActivity, [{
      key: "renderSVG",
  ...
  _exports.LocalActivity = LocalActivity;
});
//# sourceMappingURL=LocalActivity.js.map