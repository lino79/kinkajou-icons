define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PinDrop, _SvgIcon);

    function PinDrop() {
      _classCallCheck(this, PinDrop);

      return _possibleConstructorReturn(this, _getPrototypeOf(PinDrop).apply(this, arguments));
    }

    _createClass(PinDrop, [{
      key: "renderSVG",
