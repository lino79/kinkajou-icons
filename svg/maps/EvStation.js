define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(EvStation, _SvgIcon);

    function EvStation() {
      _classCallCheck(this, EvStation);

      return _possibleConstructorReturn(this, _getPrototypeOf(EvStation).apply(this, arguments));
    }

    _createClass(EvStation, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.maps.EvStation';
      }
    }]);
