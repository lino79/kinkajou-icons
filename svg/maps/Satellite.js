define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Satellite, _SvgIcon);

    function Satellite() {
      _classCallCheck(this, Satellite);

      return _possibleConstructorReturn(this, _getPrototypeOf(Satellite).apply(this, arguments));
    }
