define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.RestaurantMenu = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(RestaurantMenu, _SvgIcon);

    function RestaurantMenu() {
      _classCallCheck(this, RestaurantMenu);

      return _possibleConstructorReturn(this, _getPrototypeOf(RestaurantMenu).apply(this, arguments));
    }
  ...
  _exports.RestaurantMenu = RestaurantMenu;
});
