define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Subway, _SvgIcon);

    function Subway() {
      _classCallCheck(this, Subway);

      return _possibleConstructorReturn(this, _getPrototypeOf(Subway).apply(this, arguments));
    }
