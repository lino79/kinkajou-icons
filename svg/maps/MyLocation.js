define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(MyLocation, _SvgIcon);

    function MyLocation() {
      _classCallCheck(this, MyLocation);

      return _possibleConstructorReturn(this, _getPrototypeOf(MyLocation).apply(this, arguments));
    }
  ...
  _exports.MyLocation = MyLocation;
});
