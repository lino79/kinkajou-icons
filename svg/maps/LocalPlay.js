define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LocalPlay, _SvgIcon);

    function LocalPlay() {
      _classCallCheck(this, LocalPlay);

      return _possibleConstructorReturn(this, _getPrototypeOf(LocalPlay).apply(this, arguments));
    }

    _createClass(LocalPlay, [{
      key: "renderSVG",
