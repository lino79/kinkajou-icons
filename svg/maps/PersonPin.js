define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PersonPin, _SvgIcon);

    function PersonPin() {
      _classCallCheck(this, PersonPin);

      return _possibleConstructorReturn(this, _getPrototypeOf(PersonPin).apply(this, arguments));
    }

    _createClass(PersonPin, [{
      key: "renderSVG",
  ...
  _exports.PersonPin = PersonPin;
});
//# sourceMappingURL=PersonPin.js.map