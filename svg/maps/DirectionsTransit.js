define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.DirectionsTransit = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(DirectionsTransit, _SvgIcon);

    function DirectionsTransit() {
      _classCallCheck(this, DirectionsTransit);

      return _possibleConstructorReturn(this, _getPrototypeOf(DirectionsTransit).apply(this, arguments));
    }

    _createClass(DirectionsTransit, [{
      key: "renderSVG",
  ...
  _exports.DirectionsTransit = DirectionsTransit;
});
//# sourceMappingURL=DirectionsTransit.js.map