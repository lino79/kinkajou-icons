define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LocalDrink, _SvgIcon);

    function LocalDrink() {
      _classCallCheck(this, LocalDrink);

      return _possibleConstructorReturn(this, _getPrototypeOf(LocalDrink).apply(this, arguments));
    }

    _createClass(LocalDrink, [{
      key: "renderSVG",
  ...
  _exports.LocalDrink = LocalDrink;
});
//# sourceMappingURL=LocalDrink.js.map