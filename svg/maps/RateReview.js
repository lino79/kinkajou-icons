define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(RateReview, _SvgIcon);

    function RateReview() {
      _classCallCheck(this, RateReview);

      return _possibleConstructorReturn(this, _getPrototypeOf(RateReview).apply(this, arguments));
    }

    _createClass(RateReview, [{
      key: "renderSVG",
  ...
  _exports.RateReview = RateReview;
});
