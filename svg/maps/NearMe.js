define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(NearMe, _SvgIcon);

    function NearMe() {
      _classCallCheck(this, NearMe);

      return _possibleConstructorReturn(this, _getPrototypeOf(NearMe).apply(this, arguments));
    }
