define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LocalMall, _SvgIcon);

    function LocalMall() {
      _classCallCheck(this, LocalMall);

      return _possibleConstructorReturn(this, _getPrototypeOf(LocalMall).apply(this, arguments));
    }

    _createClass(LocalMall, [{
      key: "renderSVG",
  ...
  _exports.LocalMall = LocalMall;
});
//# sourceMappingURL=LocalMall.js.map