define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LocalPizza, _SvgIcon);

    function LocalPizza() {
      _classCallCheck(this, LocalPizza);

      return _possibleConstructorReturn(this, _getPrototypeOf(LocalPizza).apply(this, arguments));
    }

    _createClass(LocalPizza, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.maps.LocalPizza';
      }
    }]);
  ...
  _exports.LocalPizza = LocalPizza;
});
//# sourceMappingURL=LocalPizza.js.map