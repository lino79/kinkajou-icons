define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(EditLocation, _SvgIcon);

    function EditLocation() {
      _classCallCheck(this, EditLocation);

      return _possibleConstructorReturn(this, _getPrototypeOf(EditLocation).apply(this, arguments));
    }
  ...
  _exports.EditLocation = EditLocation;
});
