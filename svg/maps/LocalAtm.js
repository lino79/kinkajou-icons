define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LocalAtm, _SvgIcon);

    function LocalAtm() {
      _classCallCheck(this, LocalAtm);

      return _possibleConstructorReturn(this, _getPrototypeOf(LocalAtm).apply(this, arguments));
    }

    _createClass(LocalAtm, [{
      key: "renderSVG",
  ...
  _exports.LocalAtm = LocalAtm;
});
//# sourceMappingURL=LocalAtm.js.map