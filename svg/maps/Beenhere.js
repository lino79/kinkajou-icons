define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Beenhere, _SvgIcon);

    function Beenhere() {
      _classCallCheck(this, Beenhere);

      return _possibleConstructorReturn(this, _getPrototypeOf(Beenhere).apply(this, arguments));
    }

    _createClass(Beenhere, [{
      key: "renderSVG",
  ...
  _exports.Beenhere = Beenhere;
});
//# sourceMappingURL=Beenhere.js.map