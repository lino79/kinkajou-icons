define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Flight, _SvgIcon);

    function Flight() {
      _classCallCheck(this, Flight);

      return _possibleConstructorReturn(this, _getPrototypeOf(Flight).apply(this, arguments));
    }
