define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LayersClear, _SvgIcon);

    function LayersClear() {
      _classCallCheck(this, LayersClear);

      return _possibleConstructorReturn(this, _getPrototypeOf(LayersClear).apply(this, arguments));
    }

    _createClass(LayersClear, [{
      key: "renderSVG",
  ...
  _exports.LayersClear = LayersClear;
});
//# sourceMappingURL=LayersClear.js.map