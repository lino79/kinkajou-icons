define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.LocalGasStation = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LocalGasStation, _SvgIcon);

    function LocalGasStation() {
      _classCallCheck(this, LocalGasStation);

      return _possibleConstructorReturn(this, _getPrototypeOf(LocalGasStation).apply(this, arguments));
    }

    _createClass(LocalGasStation, [{
      key: "renderSVG",
  ...
  _exports.LocalGasStation = LocalGasStation;
});
//# sourceMappingURL=LocalGasStation.js.map