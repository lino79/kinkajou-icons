define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LocalPhone, _SvgIcon);

    function LocalPhone() {
      _classCallCheck(this, LocalPhone);

      return _possibleConstructorReturn(this, _getPrototypeOf(LocalPhone).apply(this, arguments));
    }
  ...
  _exports.LocalPhone = LocalPhone;
});
//# sourceMappingURL=LocalPhone.js.map