define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Streetview, _SvgIcon);

    function Streetview() {
      _classCallCheck(this, Streetview);

      return _possibleConstructorReturn(this, _getPrototypeOf(Streetview).apply(this, arguments));
    }
  ...
  _exports.Streetview = Streetview;
});
