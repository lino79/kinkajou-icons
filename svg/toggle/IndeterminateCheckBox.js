define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.IndeterminateCheckBox = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(IndeterminateCheckBox, _SvgIcon);

    function IndeterminateCheckBox() {
      _classCallCheck(this, IndeterminateCheckBox);

      return _possibleConstructorReturn(this, _getPrototypeOf(IndeterminateCheckBox).apply(this, arguments));
    }
    ...
    _createClass(IndeterminateCheckBox, [{
      ...
      key: "is",
      get: function get() {
        return 'material.toggle.IndeterminateCheckBox';
      }
    }]);
  ...
  _exports.IndeterminateCheckBox = IndeterminateCheckBox;
});
