define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(TimeToLeave, _SvgIcon);

    function TimeToLeave() {
      _classCallCheck(this, TimeToLeave);

      return _possibleConstructorReturn(this, _getPrototypeOf(TimeToLeave).apply(this, arguments));
    }
    ...
    _createClass(TimeToLeave, [{
      ...
      key: "is",
      get: function get() {
        return 'material.notification.TimeToLeave';
      }
    }]);
  ...
  _exports.TimeToLeave = TimeToLeave;
});
//# sourceMappingURL=TimeToLeave.js.map