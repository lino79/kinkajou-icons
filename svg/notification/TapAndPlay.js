define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(TapAndPlay, _SvgIcon);

    function TapAndPlay() {
      _classCallCheck(this, TapAndPlay);

      return _possibleConstructorReturn(this, _getPrototypeOf(TapAndPlay).apply(this, arguments));
    }

    _createClass(TapAndPlay, [{
      key: "renderSVG",
  ...
  _exports.TapAndPlay = TapAndPlay;
});
