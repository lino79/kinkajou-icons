define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.ConfirmationNumber = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ConfirmationNumber, _SvgIcon);

    function ConfirmationNumber() {
      _classCallCheck(this, ConfirmationNumber);

      return _possibleConstructorReturn(this, _getPrototypeOf(ConfirmationNumber).apply(this, arguments));
    }

    _createClass(ConfirmationNumber, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.notification.ConfirmationNumber';
      }
    }]);
  ...
  _exports.ConfirmationNumber = ConfirmationNumber;
});
