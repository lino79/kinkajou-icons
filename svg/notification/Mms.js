define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Mms, _SvgIcon);

    function Mms() {
      _classCallCheck(this, Mms);

      return _possibleConstructorReturn(this, _getPrototypeOf(Mms).apply(this, arguments));
    }
