define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(OndemandVideo, _SvgIcon);

    function OndemandVideo() {
      _classCallCheck(this, OndemandVideo);

      return _possibleConstructorReturn(this, _getPrototypeOf(OndemandVideo).apply(this, arguments));
    }

    _createClass(OndemandVideo, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.notification.OndemandVideo';
      }
    }]);
  ...
  _exports.OndemandVideo = OndemandVideo;
});
//# sourceMappingURL=OndemandVideo.js.map