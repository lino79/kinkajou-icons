define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SdCard, _SvgIcon);

    function SdCard() {
      _classCallCheck(this, SdCard);

      return _possibleConstructorReturn(this, _getPrototypeOf(SdCard).apply(this, arguments));
    }
    ...
    _createClass(SdCard, [{
      ...
      key: "is",
      get: function get() {
        return 'material.notification.SdCard';
      }
    }]);
