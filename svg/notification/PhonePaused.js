define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PhonePaused, _SvgIcon);

    function PhonePaused() {
      _classCallCheck(this, PhonePaused);

      return _possibleConstructorReturn(this, _getPrototypeOf(PhonePaused).apply(this, arguments));
    }

    _createClass(PhonePaused, [{
      key: "renderSVG",
  ...
  _exports.PhonePaused = PhonePaused;
});
