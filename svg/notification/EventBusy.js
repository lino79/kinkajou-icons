define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(EventBusy, _SvgIcon);

    function EventBusy() {
      _classCallCheck(this, EventBusy);

      return _possibleConstructorReturn(this, _getPrototypeOf(EventBusy).apply(this, arguments));
    }

    _createClass(EventBusy, [{
      key: "renderSVG",
  ...
  _exports.EventBusy = EventBusy;
});
//# sourceMappingURL=EventBusy.js.map