define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FolderSpecial, _SvgIcon);

    function FolderSpecial() {
      _classCallCheck(this, FolderSpecial);

      return _possibleConstructorReturn(this, _getPrototypeOf(FolderSpecial).apply(this, arguments));
    }

    _createClass(FolderSpecial, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.notification.FolderSpecial';
      }
    }]);
  ...
  _exports.FolderSpecial = FolderSpecial;
});
