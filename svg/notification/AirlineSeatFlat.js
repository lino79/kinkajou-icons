define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.AirlineSeatFlat = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AirlineSeatFlat, _SvgIcon);

    function AirlineSeatFlat() {
      _classCallCheck(this, AirlineSeatFlat);

      return _possibleConstructorReturn(this, _getPrototypeOf(AirlineSeatFlat).apply(this, arguments));
    }

    _createClass(AirlineSeatFlat, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.notification.AirlineSeatFlat';
      }
    }]);
  ...
  _exports.AirlineSeatFlat = AirlineSeatFlat;
});
