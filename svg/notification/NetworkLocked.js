define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(NetworkLocked, _SvgIcon);

    function NetworkLocked() {
      _classCallCheck(this, NetworkLocked);

      return _possibleConstructorReturn(this, _getPrototypeOf(NetworkLocked).apply(this, arguments));
    }

    _createClass(NetworkLocked, [{
      key: "renderSVG",
  ...
  _exports.NetworkLocked = NetworkLocked;
});
