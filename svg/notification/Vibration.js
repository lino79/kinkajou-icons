define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Vibration, _SvgIcon);

    function Vibration() {
      _classCallCheck(this, Vibration);

      return _possibleConstructorReturn(this, _getPrototypeOf(Vibration).apply(this, arguments));
    }
