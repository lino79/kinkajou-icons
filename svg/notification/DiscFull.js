define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(DiscFull, _SvgIcon);

    function DiscFull() {
      _classCallCheck(this, DiscFull);

      return _possibleConstructorReturn(this, _getPrototypeOf(DiscFull).apply(this, arguments));
    }

    _createClass(DiscFull, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.notification.DiscFull';
      }
    }]);
