define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LiveTv, _SvgIcon);

    function LiveTv() {
      _classCallCheck(this, LiveTv);

      return _possibleConstructorReturn(this, _getPrototypeOf(LiveTv).apply(this, arguments));
    }
  ...
  _exports.LiveTv = LiveTv;
});
//# sourceMappingURL=LiveTv.js.map