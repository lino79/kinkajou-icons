define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.BluetoothAudio = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BluetoothAudio, _SvgIcon);

    function BluetoothAudio() {
      _classCallCheck(this, BluetoothAudio);

      return _possibleConstructorReturn(this, _getPrototypeOf(BluetoothAudio).apply(this, arguments));
    }

    _createClass(BluetoothAudio, [{
      key: "renderSVG",
  ...
  _exports.BluetoothAudio = BluetoothAudio;
});
//# sourceMappingURL=BluetoothAudio.js.map