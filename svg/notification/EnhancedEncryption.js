define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.EnhancedEncryption = void 0;
  ...
  var EnhancedEncryption =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(EnhancedEncryption, _SvgIcon);

    function EnhancedEncryption() {
      _classCallCheck(this, EnhancedEncryption);

      return _possibleConstructorReturn(this, _getPrototypeOf(EnhancedEncryption).apply(this, arguments));
    }

    _createClass(EnhancedEncryption, [{
      key: "renderSVG",
  ...
  _exports.EnhancedEncryption = EnhancedEncryption;
});
