define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SystemUpdate, _SvgIcon);

    function SystemUpdate() {
      _classCallCheck(this, SystemUpdate);

      return _possibleConstructorReturn(this, _getPrototypeOf(SystemUpdate).apply(this, arguments));
    }

    _createClass(SystemUpdate, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.notification.SystemUpdate';
      }
    }]);
  ...
  _exports.SystemUpdate = SystemUpdate;
});
//# sourceMappingURL=SystemUpdate.js.map