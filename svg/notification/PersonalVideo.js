define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PersonalVideo, _SvgIcon);

    function PersonalVideo() {
      _classCallCheck(this, PersonalVideo);

      return _possibleConstructorReturn(this, _getPrototypeOf(PersonalVideo).apply(this, arguments));
    }

    _createClass(PersonalVideo, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.notification.PersonalVideo';
      }
    }]);
  ...
  _exports.PersonalVideo = PersonalVideo;
});
//# sourceMappingURL=PersonalVideo.js.map