define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(NetworkCheck, _SvgIcon);

    function NetworkCheck() {
      _classCallCheck(this, NetworkCheck);

      return _possibleConstructorReturn(this, _getPrototypeOf(NetworkCheck).apply(this, arguments));
    }

    _createClass(NetworkCheck, [{
      key: "renderSVG",
  ...
  _exports.NetworkCheck = NetworkCheck;
});
