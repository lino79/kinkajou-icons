define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SyncDisabled, _SvgIcon);

    function SyncDisabled() {
      _classCallCheck(this, SyncDisabled);

      return _possibleConstructorReturn(this, _getPrototypeOf(SyncDisabled).apply(this, arguments));
    }

    _createClass(SyncDisabled, [{
      key: "renderSVG",
  ...
  _exports.SyncDisabled = SyncDisabled;
});
//# sourceMappingURL=SyncDisabled.js.map