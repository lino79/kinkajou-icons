define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.PhoneForwarded = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PhoneForwarded, _SvgIcon);

    function PhoneForwarded() {
      _classCallCheck(this, PhoneForwarded);

      return _possibleConstructorReturn(this, _getPrototypeOf(PhoneForwarded).apply(this, arguments));
    }

    _createClass(PhoneForwarded, [{
      key: "renderSVG",
  ...
  _exports.PhoneForwarded = PhoneForwarded;
});
