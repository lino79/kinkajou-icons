define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(NoEncryption, _SvgIcon);

    function NoEncryption() {
      _classCallCheck(this, NoEncryption);

      return _possibleConstructorReturn(this, _getPrototypeOf(NoEncryption).apply(this, arguments));
    }

    _createClass(NoEncryption, [{
      key: "renderSVG",
  ...
  _exports.NoEncryption = NoEncryption;
});
//# sourceMappingURL=NoEncryption.js.map