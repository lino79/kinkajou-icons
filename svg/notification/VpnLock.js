define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(VpnLock, _SvgIcon);

    function VpnLock() {
      _classCallCheck(this, VpnLock);

      return _possibleConstructorReturn(this, _getPrototypeOf(VpnLock).apply(this, arguments));
    }

    _createClass(VpnLock, [{
      key: "renderSVG",
  ...
  _exports.VpnLock = VpnLock;
});
//# sourceMappingURL=VpnLock.js.map