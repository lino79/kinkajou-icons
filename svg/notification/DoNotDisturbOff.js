define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.DoNotDisturbOff = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(DoNotDisturbOff, _SvgIcon);

    function DoNotDisturbOff() {
      _classCallCheck(this, DoNotDisturbOff);

      return _possibleConstructorReturn(this, _getPrototypeOf(DoNotDisturbOff).apply(this, arguments));
    }

    _createClass(DoNotDisturbOff, [{
      key: "renderSVG",
  ...
  _exports.DoNotDisturbOff = DoNotDisturbOff;
});
//# sourceMappingURL=DoNotDisturbOff.js.map