define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SyncProblem, _SvgIcon);

    function SyncProblem() {
      _classCallCheck(this, SyncProblem);

      return _possibleConstructorReturn(this, _getPrototypeOf(SyncProblem).apply(this, arguments));
    }

    _createClass(SyncProblem, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.notification.SyncProblem';
      }
    }]);
  ...
  _exports.SyncProblem = SyncProblem;
});
//# sourceMappingURL=SyncProblem.js.map