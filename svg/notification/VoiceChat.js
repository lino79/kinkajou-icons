define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(VoiceChat, _SvgIcon);

    function VoiceChat() {
      _classCallCheck(this, VoiceChat);

      return _possibleConstructorReturn(this, _getPrototypeOf(VoiceChat).apply(this, arguments));
    }
    ...
    _createClass(VoiceChat, [{
      ...
      key: "is",
      get: function get() {
        return 'material.notification.VoiceChat';
      }
    }]);
