define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.DoNotDisturbAlt = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(DoNotDisturbAlt, _SvgIcon);

    function DoNotDisturbAlt() {
      _classCallCheck(this, DoNotDisturbAlt);

      return _possibleConstructorReturn(this, _getPrototypeOf(DoNotDisturbAlt).apply(this, arguments));
    }

    _createClass(DoNotDisturbAlt, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.notification.DoNotDisturbAlt';
      }
    }]);
  ...
  _exports.DoNotDisturbAlt = DoNotDisturbAlt;
});
//# sourceMappingURL=DoNotDisturbAlt.js.map