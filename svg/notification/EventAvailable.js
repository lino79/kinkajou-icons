define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.EventAvailable = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(EventAvailable, _SvgIcon);

    function EventAvailable() {
      _classCallCheck(this, EventAvailable);

      return _possibleConstructorReturn(this, _getPrototypeOf(EventAvailable).apply(this, arguments));
    }

    _createClass(EventAvailable, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.notification.EventAvailable';
      }
    }]);
  ...
  _exports.EventAvailable = EventAvailable;
});
//# sourceMappingURL=EventAvailable.js.map