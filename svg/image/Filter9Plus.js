define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Filter9Plus, _SvgIcon);

    function Filter9Plus() {
      _classCallCheck(this, Filter9Plus);

      return _possibleConstructorReturn(this, _getPrototypeOf(Filter9Plus).apply(this, arguments));
    }

    _createClass(Filter9Plus, [{
      key: "renderSVG",
  ...
  _exports.Filter9Plus = Filter9Plus;
});
//# sourceMappingURL=Filter9Plus.js.map