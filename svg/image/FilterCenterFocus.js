define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.FilterCenterFocus = void 0;
  ...
  var FilterCenterFocus =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FilterCenterFocus, _SvgIcon);

    function FilterCenterFocus() {
      _classCallCheck(this, FilterCenterFocus);

      return _possibleConstructorReturn(this, _getPrototypeOf(FilterCenterFocus).apply(this, arguments));
    }

    _createClass(FilterCenterFocus, [{
      key: "renderSVG",
  ...
  _exports.FilterCenterFocus = FilterCenterFocus;
});
