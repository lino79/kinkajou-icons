define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Dehaze, _SvgIcon);

    function Dehaze() {
      _classCallCheck(this, Dehaze);

      return _possibleConstructorReturn(this, _getPrototypeOf(Dehaze).apply(this, arguments));
    }
  ...
  _exports.Dehaze = Dehaze;
});
//# sourceMappingURL=Dehaze.js.map