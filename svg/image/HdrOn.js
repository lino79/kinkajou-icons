define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(HdrOn, _SvgIcon);

    function HdrOn() {
      _classCallCheck(this, HdrOn);

      return _possibleConstructorReturn(this, _getPrototypeOf(HdrOn).apply(this, arguments));
    }
  ...
  _exports.HdrOn = HdrOn;
});
//# sourceMappingURL=HdrOn.js.map