define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.WbIncandescent = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(WbIncandescent, _SvgIcon);

    function WbIncandescent() {
      _classCallCheck(this, WbIncandescent);

      return _possibleConstructorReturn(this, _getPrototypeOf(WbIncandescent).apply(this, arguments));
    }

    _createClass(WbIncandescent, [{
      key: "renderSVG",
  ...
  _exports.WbIncandescent = WbIncandescent;
});
//# sourceMappingURL=WbIncandescent.js.map