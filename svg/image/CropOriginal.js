define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CropOriginal, _SvgIcon);

    function CropOriginal() {
      _classCallCheck(this, CropOriginal);

      return _possibleConstructorReturn(this, _getPrototypeOf(CropOriginal).apply(this, arguments));
    }

    _createClass(CropOriginal, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.CropOriginal';
      }
    }]);
  ...
  _exports.CropOriginal = CropOriginal;
});
//# sourceMappingURL=CropOriginal.js.map