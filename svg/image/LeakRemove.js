define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LeakRemove, _SvgIcon);

    function LeakRemove() {
      _classCallCheck(this, LeakRemove);

      return _possibleConstructorReturn(this, _getPrototypeOf(LeakRemove).apply(this, arguments));
    }

    _createClass(LeakRemove, [{
      key: "renderSVG",
  ...
  _exports.LeakRemove = LeakRemove;
});
//# sourceMappingURL=LeakRemove.js.map