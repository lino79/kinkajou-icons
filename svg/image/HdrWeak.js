define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(HdrWeak, _SvgIcon);

    function HdrWeak() {
      _classCallCheck(this, HdrWeak);

      return _possibleConstructorReturn(this, _getPrototypeOf(HdrWeak).apply(this, arguments));
    }

    _createClass(HdrWeak, [{
      key: "renderSVG",
  ...
  _exports.HdrWeak = HdrWeak;
});
//# sourceMappingURL=HdrWeak.js.map