define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Nature, _SvgIcon);

    function Nature() {
      _classCallCheck(this, Nature);

      return _possibleConstructorReturn(this, _getPrototypeOf(Nature).apply(this, arguments));
    }
