define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(MovieFilter, _SvgIcon);

    function MovieFilter() {
      _classCallCheck(this, MovieFilter);

      return _possibleConstructorReturn(this, _getPrototypeOf(MovieFilter).apply(this, arguments));
    }
  ...
  _exports.MovieFilter = MovieFilter;
});
//# sourceMappingURL=MovieFilter.js.map