define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CropFree, _SvgIcon);

    function CropFree() {
      _classCallCheck(this, CropFree);

      return _possibleConstructorReturn(this, _getPrototypeOf(CropFree).apply(this, arguments));
    }

    _createClass(CropFree, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.CropFree';
      }
    }]);
  ...
  _exports.CropFree = CropFree;
});
//# sourceMappingURL=CropFree.js.map