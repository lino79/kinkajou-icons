define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FlashOff, _SvgIcon);

    function FlashOff() {
      _classCallCheck(this, FlashOff);

      return _possibleConstructorReturn(this, _getPrototypeOf(FlashOff).apply(this, arguments));
    }
    ...
    _createClass(FlashOff, [{
      ...
      key: "is",
      get: function get() {
        return 'material.image.FlashOff';
      }
    }]);
