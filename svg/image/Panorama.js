define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Panorama, _SvgIcon);

    function Panorama() {
      _classCallCheck(this, Panorama);

      return _possibleConstructorReturn(this, _getPrototypeOf(Panorama).apply(this, arguments));
    }
