define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CameraRoll, _SvgIcon);

    function CameraRoll() {
      _classCallCheck(this, CameraRoll);

      return _possibleConstructorReturn(this, _getPrototypeOf(CameraRoll).apply(this, arguments));
    }

    _createClass(CameraRoll, [{
      key: "renderSVG",
  ...
  _exports.CameraRoll = CameraRoll;
});
