define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CameraRear, _SvgIcon);

    function CameraRear() {
      _classCallCheck(this, CameraRear);

      return _possibleConstructorReturn(this, _getPrototypeOf(CameraRear).apply(this, arguments));
    }

    _createClass(CameraRear, [{
      key: "renderSVG",
  ...
  _exports.CameraRear = CameraRear;
});
