define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Brightness5, _SvgIcon);

    function Brightness5() {
      _classCallCheck(this, Brightness5);

      return _possibleConstructorReturn(this, _getPrototypeOf(Brightness5).apply(this, arguments));
    }

    _createClass(Brightness5, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.Brightness5';
      }
    }]);
  ...
  _exports.Brightness5 = Brightness5;
});
