define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Adjust, _SvgIcon);

    function Adjust() {
      _classCallCheck(this, Adjust);

      return _possibleConstructorReturn(this, _getPrototypeOf(Adjust).apply(this, arguments));
    }
