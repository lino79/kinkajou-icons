define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PhotoAlbum, _SvgIcon);

    function PhotoAlbum() {
      _classCallCheck(this, PhotoAlbum);

      return _possibleConstructorReturn(this, _getPrototypeOf(PhotoAlbum).apply(this, arguments));
    }
  ...
  _exports.PhotoAlbum = PhotoAlbum;
});
