define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(GridOff, _SvgIcon);

    function GridOff() {
      _classCallCheck(this, GridOff);

      return _possibleConstructorReturn(this, _getPrototypeOf(GridOff).apply(this, arguments));
    }

    _createClass(GridOff, [{
      key: "renderSVG",
