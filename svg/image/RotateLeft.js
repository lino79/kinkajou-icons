define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(RotateLeft, _SvgIcon);

    function RotateLeft() {
      _classCallCheck(this, RotateLeft);

      return _possibleConstructorReturn(this, _getPrototypeOf(RotateLeft).apply(this, arguments));
    }
  ...
  _exports.RotateLeft = RotateLeft;
});
