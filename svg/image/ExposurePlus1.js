define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ExposurePlus1, _SvgIcon);

    function ExposurePlus1() {
      _classCallCheck(this, ExposurePlus1);

      return _possibleConstructorReturn(this, _getPrototypeOf(ExposurePlus1).apply(this, arguments));
    }

    _createClass(ExposurePlus1, [{
      key: "renderSVG",
  ...
  _exports.ExposurePlus1 = ExposurePlus1;
});
//# sourceMappingURL=ExposurePlus1.js.map