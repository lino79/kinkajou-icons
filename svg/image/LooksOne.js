define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LooksOne, _SvgIcon);

    function LooksOne() {
      _classCallCheck(this, LooksOne);

      return _possibleConstructorReturn(this, _getPrototypeOf(LooksOne).apply(this, arguments));
    }

    _createClass(LooksOne, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.LooksOne';
      }
    }]);
  ...
  _exports.LooksOne = LooksOne;
});
//# sourceMappingURL=LooksOne.js.map