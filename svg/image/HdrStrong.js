define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(HdrStrong, _SvgIcon);

    function HdrStrong() {
      _classCallCheck(this, HdrStrong);

      return _possibleConstructorReturn(this, _getPrototypeOf(HdrStrong).apply(this, arguments));
    }

    _createClass(HdrStrong, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.HdrStrong';
      }
    }]);
  ...
  _exports.HdrStrong = HdrStrong;
});
//# sourceMappingURL=HdrStrong.js.map