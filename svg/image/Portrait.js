define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Portrait, _SvgIcon);

    function Portrait() {
      _classCallCheck(this, Portrait);

      return _possibleConstructorReturn(this, _getPrototypeOf(Portrait).apply(this, arguments));
    }
