define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AddAPhoto, _SvgIcon);

    function AddAPhoto() {
      _classCallCheck(this, AddAPhoto);

      return _possibleConstructorReturn(this, _getPrototypeOf(AddAPhoto).apply(this, arguments));
    }

    _createClass(AddAPhoto, [{
      key: "renderSVG",
  ...
  _exports.AddAPhoto = AddAPhoto;
});
//# sourceMappingURL=AddAPhoto.js.map