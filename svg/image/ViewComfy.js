define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ViewComfy, _SvgIcon);

    function ViewComfy() {
      _classCallCheck(this, ViewComfy);

      return _possibleConstructorReturn(this, _getPrototypeOf(ViewComfy).apply(this, arguments));
    }

    _createClass(ViewComfy, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.ViewComfy';
      }
    }]);
  ...
  _exports.ViewComfy = ViewComfy;
});
//# sourceMappingURL=ViewComfy.js.map