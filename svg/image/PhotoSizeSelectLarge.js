define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.PhotoSizeSelectLarge = void 0;
  ...
  var PhotoSizeSelectLarge =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PhotoSizeSelectLarge, _SvgIcon);

    function PhotoSizeSelectLarge() {
      _classCallCheck(this, PhotoSizeSelectLarge);

      return _possibleConstructorReturn(this, _getPrototypeOf(PhotoSizeSelectLarge).apply(this, arguments));
    }

    _createClass(PhotoSizeSelectLarge, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.PhotoSizeSelectLarge';
      }
    }]);
  ...
  _exports.PhotoSizeSelectLarge = PhotoSizeSelectLarge;
});
