define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Crop54, _SvgIcon);

    function Crop54() {
      _classCallCheck(this, Crop54);

      return _possibleConstructorReturn(this, _getPrototypeOf(Crop54).apply(this, arguments));
    }
