define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Filter1, _SvgIcon);

    function Filter1() {
      _classCallCheck(this, Filter1);

      return _possibleConstructorReturn(this, _getPrototypeOf(Filter1).apply(this, arguments));
    }

    _createClass(Filter1, [{
      key: "renderSVG",
