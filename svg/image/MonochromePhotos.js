define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.MonochromePhotos = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(MonochromePhotos, _SvgIcon);

    function MonochromePhotos() {
      _classCallCheck(this, MonochromePhotos);

      return _possibleConstructorReturn(this, _getPrototypeOf(MonochromePhotos).apply(this, arguments));
    }

    _createClass(MonochromePhotos, [{
      key: "renderSVG",
  ...
  _exports.MonochromePhotos = MonochromePhotos;
});
//# sourceMappingURL=MonochromePhotos.js.map