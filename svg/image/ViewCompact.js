define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ViewCompact, _SvgIcon);

    function ViewCompact() {
      _classCallCheck(this, ViewCompact);

      return _possibleConstructorReturn(this, _getPrototypeOf(ViewCompact).apply(this, arguments));
    }

    _createClass(ViewCompact, [{
      key: "renderSVG",
  ...
  _exports.ViewCompact = ViewCompact;
});
//# sourceMappingURL=ViewCompact.js.map