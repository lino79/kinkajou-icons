define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FilterHdr, _SvgIcon);

    function FilterHdr() {
      _classCallCheck(this, FilterHdr);

      return _possibleConstructorReturn(this, _getPrototypeOf(FilterHdr).apply(this, arguments));
    }

    _createClass(FilterHdr, [{
      key: "renderSVG",
  ...
  _exports.FilterHdr = FilterHdr;
});
//# sourceMappingURL=FilterHdr.js.map