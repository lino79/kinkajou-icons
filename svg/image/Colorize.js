define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Colorize, _SvgIcon);

    function Colorize() {
      _classCallCheck(this, Colorize);

      return _possibleConstructorReturn(this, _getPrototypeOf(Colorize).apply(this, arguments));
    }
