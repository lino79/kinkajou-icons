define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CropLandscape, _SvgIcon);

    function CropLandscape() {
      _classCallCheck(this, CropLandscape);

      return _possibleConstructorReturn(this, _getPrototypeOf(CropLandscape).apply(this, arguments));
    }

    _createClass(CropLandscape, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.CropLandscape';
      }
    }]);
  ...
  _exports.CropLandscape = CropLandscape;
});
//# sourceMappingURL=CropLandscape.js.map