define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Flare, _SvgIcon);

    function Flare() {
      _classCallCheck(this, Flare);

      return _possibleConstructorReturn(this, _getPrototypeOf(Flare).apply(this, arguments));
    }
