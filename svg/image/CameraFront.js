define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CameraFront, _SvgIcon);

    function CameraFront() {
      _classCallCheck(this, CameraFront);

      return _possibleConstructorReturn(this, _getPrototypeOf(CameraFront).apply(this, arguments));
    }

    _createClass(CameraFront, [{
      key: "renderSVG",
  ...
  _exports.CameraFront = CameraFront;
});
//# sourceMappingURL=CameraFront.js.map