define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.ImageAspectRatio = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ImageAspectRatio, _SvgIcon);

    function ImageAspectRatio() {
      _classCallCheck(this, ImageAspectRatio);

      return _possibleConstructorReturn(this, _getPrototypeOf(ImageAspectRatio).apply(this, arguments));
    }

    _createClass(ImageAspectRatio, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.ImageAspectRatio';
      }
    }]);
  ...
  _exports.ImageAspectRatio = ImageAspectRatio;
});
