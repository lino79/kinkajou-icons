define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.PanoramaWideAngle = void 0;
  ...
  var PanoramaWideAngle =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PanoramaWideAngle, _SvgIcon);

    function PanoramaWideAngle() {
      _classCallCheck(this, PanoramaWideAngle);

      return _possibleConstructorReturn(this, _getPrototypeOf(PanoramaWideAngle).apply(this, arguments));
    }

    _createClass(PanoramaWideAngle, [{
      key: "renderSVG",
  ...
  _exports.PanoramaWideAngle = PanoramaWideAngle;
});
