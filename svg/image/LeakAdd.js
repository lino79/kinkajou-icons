define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LeakAdd, _SvgIcon);

    function LeakAdd() {
      _classCallCheck(this, LeakAdd);

      return _possibleConstructorReturn(this, _getPrototypeOf(LeakAdd).apply(this, arguments));
    }

    _createClass(LeakAdd, [{
      key: "renderSVG",
  ...
  _exports.LeakAdd = LeakAdd;
});
//# sourceMappingURL=LeakAdd.js.map