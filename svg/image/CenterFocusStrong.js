define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.CenterFocusStrong = void 0;
  ...
  var CenterFocusStrong =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CenterFocusStrong, _SvgIcon);

    function CenterFocusStrong() {
      _classCallCheck(this, CenterFocusStrong);

      return _possibleConstructorReturn(this, _getPrototypeOf(CenterFocusStrong).apply(this, arguments));
    }

    _createClass(CenterFocusStrong, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.CenterFocusStrong';
      }
    }]);
  ...
  _exports.CenterFocusStrong = CenterFocusStrong;
});
