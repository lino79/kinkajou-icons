define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FilterVintage, _SvgIcon);

    function FilterVintage() {
      _classCallCheck(this, FilterVintage);

      return _possibleConstructorReturn(this, _getPrototypeOf(FilterVintage).apply(this, arguments));
    }

    _createClass(FilterVintage, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.FilterVintage';
      }
    }]);
  ...
  _exports.FilterVintage = FilterVintage;
});
//# sourceMappingURL=FilterVintage.js.map