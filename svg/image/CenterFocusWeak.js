define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.CenterFocusWeak = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CenterFocusWeak, _SvgIcon);

    function CenterFocusWeak() {
      _classCallCheck(this, CenterFocusWeak);

      return _possibleConstructorReturn(this, _getPrototypeOf(CenterFocusWeak).apply(this, arguments));
    }

    _createClass(CenterFocusWeak, [{
      key: "renderSVG",
  ...
  _exports.CenterFocusWeak = CenterFocusWeak;
});
