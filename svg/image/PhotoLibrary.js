define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PhotoLibrary, _SvgIcon);

    function PhotoLibrary() {
      _classCallCheck(this, PhotoLibrary);

      return _possibleConstructorReturn(this, _getPrototypeOf(PhotoLibrary).apply(this, arguments));
    }

    _createClass(PhotoLibrary, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.PhotoLibrary';
      }
    }]);
  ...
  _exports.PhotoLibrary = PhotoLibrary;
});
