define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(WbCloudy, _SvgIcon);

    function WbCloudy() {
      _classCallCheck(this, WbCloudy);

      return _possibleConstructorReturn(this, _getPrototypeOf(WbCloudy).apply(this, arguments));
    }

    _createClass(WbCloudy, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.WbCloudy';
      }
    }]);
  ...
  _exports.WbCloudy = WbCloudy;
});
//# sourceMappingURL=WbCloudy.js.map