define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Collections, _SvgIcon);

    function Collections() {
      _classCallCheck(this, Collections);

      return _possibleConstructorReturn(this, _getPrototypeOf(Collections).apply(this, arguments));
    }
  ...
  _exports.Collections = Collections;
});
