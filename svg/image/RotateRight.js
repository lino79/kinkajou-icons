define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(RotateRight, _SvgIcon);

    function RotateRight() {
      _classCallCheck(this, RotateRight);

      return _possibleConstructorReturn(this, _getPrototypeOf(RotateRight).apply(this, arguments));
    }
  ...
  _exports.RotateRight = RotateRight;
});
