define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FilterFrames, _SvgIcon);

    function FilterFrames() {
      _classCallCheck(this, FilterFrames);

      return _possibleConstructorReturn(this, _getPrototypeOf(FilterFrames).apply(this, arguments));
    }

    _createClass(FilterFrames, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.FilterFrames';
      }
    }]);
  ...
  _exports.FilterFrames = FilterFrames;
});
//# sourceMappingURL=FilterFrames.js.map