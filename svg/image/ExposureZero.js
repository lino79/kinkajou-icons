define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ExposureZero, _SvgIcon);

    function ExposureZero() {
      _classCallCheck(this, ExposureZero);

      return _possibleConstructorReturn(this, _getPrototypeOf(ExposureZero).apply(this, arguments));
    }

    _createClass(ExposureZero, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.ExposureZero';
      }
    }]);
  ...
  _exports.ExposureZero = ExposureZero;
});
//# sourceMappingURL=ExposureZero.js.map