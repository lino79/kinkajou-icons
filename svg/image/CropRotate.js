define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CropRotate, _SvgIcon);

    function CropRotate() {
      _classCallCheck(this, CropRotate);

      return _possibleConstructorReturn(this, _getPrototypeOf(CropRotate).apply(this, arguments));
    }

    _createClass(CropRotate, [{
      key: "renderSVG",
  ...
  _exports.CropRotate = CropRotate;
});
//# sourceMappingURL=CropRotate.js.map