define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SwitchVideo, _SvgIcon);

    function SwitchVideo() {
      _classCallCheck(this, SwitchVideo);

      return _possibleConstructorReturn(this, _getPrototypeOf(SwitchVideo).apply(this, arguments));
    }

    _createClass(SwitchVideo, [{
      key: "renderSVG",
  ...
  _exports.SwitchVideo = SwitchVideo;
});
