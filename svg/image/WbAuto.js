define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(WbAuto, _SvgIcon);

    function WbAuto() {
      _classCallCheck(this, WbAuto);

      return _possibleConstructorReturn(this, _getPrototypeOf(WbAuto).apply(this, arguments));
    }
