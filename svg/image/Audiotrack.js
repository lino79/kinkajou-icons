define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Audiotrack, _SvgIcon);

    function Audiotrack() {
      _classCallCheck(this, Audiotrack);

      return _possibleConstructorReturn(this, _getPrototypeOf(Audiotrack).apply(this, arguments));
    }
    ...
    _createClass(Audiotrack, [{
      ...
      key: "is",
      get: function get() {
        return 'material.image.Audiotrack';
      }
    }]);
  ...
  _exports.Audiotrack = Audiotrack;
});
