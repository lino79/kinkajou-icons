define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BrokenImage, _SvgIcon);

    function BrokenImage() {
      _classCallCheck(this, BrokenImage);

      return _possibleConstructorReturn(this, _getPrototypeOf(BrokenImage).apply(this, arguments));
    }

    _createClass(BrokenImage, [{
      key: "renderSVG",
  ...
  _exports.BrokenImage = BrokenImage;
});
