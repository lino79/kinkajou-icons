define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Loupe, _SvgIcon);

    function Loupe() {
      _classCallCheck(this, Loupe);

      return _possibleConstructorReturn(this, _getPrototypeOf(Loupe).apply(this, arguments));
    }
