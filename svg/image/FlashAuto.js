define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FlashAuto, _SvgIcon);

    function FlashAuto() {
      _classCallCheck(this, FlashAuto);

      return _possibleConstructorReturn(this, _getPrototypeOf(FlashAuto).apply(this, arguments));
    }

    _createClass(FlashAuto, [{
      key: "renderSVG",
