define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Grain, _SvgIcon);

    function Grain() {
      _classCallCheck(this, Grain);

      return _possibleConstructorReturn(this, _getPrototypeOf(Grain).apply(this, arguments));
    }
