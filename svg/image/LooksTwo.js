define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LooksTwo, _SvgIcon);

    function LooksTwo() {
      _classCallCheck(this, LooksTwo);

      return _possibleConstructorReturn(this, _getPrototypeOf(LooksTwo).apply(this, arguments));
    }

    _createClass(LooksTwo, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.LooksTwo';
      }
    }]);
  ...
  _exports.LooksTwo = LooksTwo;
});
//# sourceMappingURL=LooksTwo.js.map