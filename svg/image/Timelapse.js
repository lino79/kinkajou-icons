define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Timelapse, _SvgIcon);

    function Timelapse() {
      _classCallCheck(this, Timelapse);

      return _possibleConstructorReturn(this, _getPrototypeOf(Timelapse).apply(this, arguments));
    }

    _createClass(Timelapse, [{
      key: "renderSVG",
