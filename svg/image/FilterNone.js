define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FilterNone, _SvgIcon);

    function FilterNone() {
      _classCallCheck(this, FilterNone);

      return _possibleConstructorReturn(this, _getPrototypeOf(FilterNone).apply(this, arguments));
    }

    _createClass(FilterNone, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.FilterNone';
      }
    }]);
  ...
  _exports.FilterNone = FilterNone;
});
//# sourceMappingURL=FilterNone.js.map