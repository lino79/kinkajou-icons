define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Filter3, _SvgIcon);

    function Filter3() {
      _classCallCheck(this, Filter3);

      return _possibleConstructorReturn(this, _getPrototypeOf(Filter3).apply(this, arguments));
    }

    _createClass(Filter3, [{
      key: "renderSVG",
