define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ControlPoint, _SvgIcon);

    function ControlPoint() {
      _classCallCheck(this, ControlPoint);

      return _possibleConstructorReturn(this, _getPrototypeOf(ControlPoint).apply(this, arguments));
    }
  ...
  _exports.ControlPoint = ControlPoint;
});
