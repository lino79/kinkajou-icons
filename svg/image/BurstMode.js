define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BurstMode, _SvgIcon);

    function BurstMode() {
      _classCallCheck(this, BurstMode);

      return _possibleConstructorReturn(this, _getPrototypeOf(BurstMode).apply(this, arguments));
    }

    _createClass(BurstMode, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.BurstMode';
      }
    }]);
  ...
  _exports.BurstMode = BurstMode;
});
//# sourceMappingURL=BurstMode.js.map