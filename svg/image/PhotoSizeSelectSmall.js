define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.PhotoSizeSelectSmall = void 0;
  ...
  var PhotoSizeSelectSmall =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PhotoSizeSelectSmall, _SvgIcon);

    function PhotoSizeSelectSmall() {
      _classCallCheck(this, PhotoSizeSelectSmall);

      return _possibleConstructorReturn(this, _getPrototypeOf(PhotoSizeSelectSmall).apply(this, arguments));
    }

    _createClass(PhotoSizeSelectSmall, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.PhotoSizeSelectSmall';
      }
    }]);
  ...
  _exports.PhotoSizeSelectSmall = PhotoSizeSelectSmall;
});
