define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PhotoFilter, _SvgIcon);

    function PhotoFilter() {
      _classCallCheck(this, PhotoFilter);

      return _possibleConstructorReturn(this, _getPrototypeOf(PhotoFilter).apply(this, arguments));
    }

    _createClass(PhotoFilter, [{
      key: "renderSVG",
  ...
  _exports.PhotoFilter = PhotoFilter;
});
//# sourceMappingURL=PhotoFilter.js.map