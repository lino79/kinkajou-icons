define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Assistant, _SvgIcon);

    function Assistant() {
      _classCallCheck(this, Assistant);

      return _possibleConstructorReturn(this, _getPrototypeOf(Assistant).apply(this, arguments));
    }
