define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SwitchCamera, _SvgIcon);

    function SwitchCamera() {
      _classCallCheck(this, SwitchCamera);

      return _possibleConstructorReturn(this, _getPrototypeOf(SwitchCamera).apply(this, arguments));
    }

    _createClass(SwitchCamera, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.image.SwitchCamera';
      }
    }]);
  ...
  _exports.SwitchCamera = SwitchCamera;
});
