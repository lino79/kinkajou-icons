define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CloudCircle, _SvgIcon);

    function CloudCircle() {
      _classCallCheck(this, CloudCircle);

      return _possibleConstructorReturn(this, _getPrototypeOf(CloudCircle).apply(this, arguments));
    }

    _createClass(CloudCircle, [{
      key: "renderSVG",
  ...
  _exports.CloudCircle = CloudCircle;
});
