define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CloudOff, _SvgIcon);

    function CloudOff() {
      _classCallCheck(this, CloudOff);

      return _possibleConstructorReturn(this, _getPrototypeOf(CloudOff).apply(this, arguments));
    }

    _createClass(CloudOff, [{
      key: "renderSVG",
