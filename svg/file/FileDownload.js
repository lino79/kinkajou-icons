define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FileDownload, _SvgIcon);

    function FileDownload() {
      _classCallCheck(this, FileDownload);

      return _possibleConstructorReturn(this, _getPrototypeOf(FileDownload).apply(this, arguments));
    }
  ...
  _exports.FileDownload = FileDownload;
});
