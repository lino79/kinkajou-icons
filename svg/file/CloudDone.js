define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CloudDone, _SvgIcon);

    function CloudDone() {
      _classCallCheck(this, CloudDone);

      return _possibleConstructorReturn(this, _getPrototypeOf(CloudDone).apply(this, arguments));
    }

    _createClass(CloudDone, [{
      key: "renderSVG",
