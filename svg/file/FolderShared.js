define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FolderShared, _SvgIcon);

    function FolderShared() {
      _classCallCheck(this, FolderShared);

      return _possibleConstructorReturn(this, _getPrototypeOf(FolderShared).apply(this, arguments));
    }

    _createClass(FolderShared, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.file.FolderShared';
      }
    }]);
  ...
  _exports.FolderShared = FolderShared;
});
