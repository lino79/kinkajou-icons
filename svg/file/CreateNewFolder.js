define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.CreateNewFolder = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CreateNewFolder, _SvgIcon);

    function CreateNewFolder() {
      _classCallCheck(this, CreateNewFolder);

      return _possibleConstructorReturn(this, _getPrototypeOf(CreateNewFolder).apply(this, arguments));
    }

    _createClass(CreateNewFolder, [{
      key: "renderSVG",
  ...
  _exports.CreateNewFolder = CreateNewFolder;
});
//# sourceMappingURL=CreateNewFolder.js.map