define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CloudQueue, _SvgIcon);

    function CloudQueue() {
      _classCallCheck(this, CloudQueue);

      return _possibleConstructorReturn(this, _getPrototypeOf(CloudQueue).apply(this, arguments));
    }
  ...
  _exports.CloudQueue = CloudQueue;
});
