define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AddAlert, _SvgIcon);

    function AddAlert() {
      _classCallCheck(this, AddAlert);

      return _possibleConstructorReturn(this, _getPrototypeOf(AddAlert).apply(this, arguments));
    }

    _createClass(AddAlert, [{
      key: "renderSVG",
