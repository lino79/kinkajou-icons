define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Drafts, _SvgIcon);

    function Drafts() {
      _classCallCheck(this, Drafts);

      return _possibleConstructorReturn(this, _getPrototypeOf(Drafts).apply(this, arguments));
    }
