define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Weekend, _SvgIcon);

    function Weekend() {
      _classCallCheck(this, Weekend);

      return _possibleConstructorReturn(this, _getPrototypeOf(Weekend).apply(this, arguments));
    }
    ...
    _createClass(Weekend, [{
      ...
      key: "is",
      get: function get() {
        return 'material.content.Weekend';
      }
    }]);
