define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ReplyAll, _SvgIcon);

    function ReplyAll() {
      _classCallCheck(this, ReplyAll);

      return _possibleConstructorReturn(this, _getPrototypeOf(ReplyAll).apply(this, arguments));
    }
    ...
    _createClass(ReplyAll, [{
      ...
      key: "is",
      get: function get() {
        return 'material.content.ReplyAll';
      }
    }]);
