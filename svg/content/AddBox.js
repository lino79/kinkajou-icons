define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AddBox, _SvgIcon);

    function AddBox() {
      _classCallCheck(this, AddBox);

      return _possibleConstructorReturn(this, _getPrototypeOf(AddBox).apply(this, arguments));
    }
