define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LowPriority, _SvgIcon);

    function LowPriority() {
      _classCallCheck(this, LowPriority);

      return _possibleConstructorReturn(this, _getPrototypeOf(LowPriority).apply(this, arguments));
    }

    _createClass(LowPriority, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.content.LowPriority';
      }
    }]);
  ...
  _exports.LowPriority = LowPriority;
});
//# sourceMappingURL=LowPriority.js.map