define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FontDownload, _SvgIcon);

    function FontDownload() {
      _classCallCheck(this, FontDownload);

      return _possibleConstructorReturn(this, _getPrototypeOf(FontDownload).apply(this, arguments));
    }

    _createClass(FontDownload, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.content.FontDownload';
      }
    }]);
  ...
  _exports.FontDownload = FontDownload;
});
//# sourceMappingURL=FontDownload.js.map