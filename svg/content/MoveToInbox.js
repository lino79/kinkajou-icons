define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(MoveToInbox, _SvgIcon);

    function MoveToInbox() {
      _classCallCheck(this, MoveToInbox);

      return _possibleConstructorReturn(this, _getPrototypeOf(MoveToInbox).apply(this, arguments));
    }

    _createClass(MoveToInbox, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.content.MoveToInbox';
      }
    }]);
  ...
  _exports.MoveToInbox = MoveToInbox;
});
//# sourceMappingURL=MoveToInbox.js.map