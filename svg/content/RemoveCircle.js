define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(RemoveCircle, _SvgIcon);

    function RemoveCircle() {
      _classCallCheck(this, RemoveCircle);

      return _possibleConstructorReturn(this, _getPrototypeOf(RemoveCircle).apply(this, arguments));
    }
    ...
    _createClass(RemoveCircle, [{
      ...
      key: "is",
      get: function get() {
        return 'material.content.RemoveCircle';
      }
    }]);
  ...
  _exports.RemoveCircle = RemoveCircle;
});
