define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ContentCopy, _SvgIcon);

    function ContentCopy() {
      _classCallCheck(this, ContentCopy);

      return _possibleConstructorReturn(this, _getPrototypeOf(ContentCopy).apply(this, arguments));
    }

    _createClass(ContentCopy, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.content.ContentCopy';
      }
    }]);
  ...
  _exports.ContentCopy = ContentCopy;
});
