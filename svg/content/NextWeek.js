define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(NextWeek, _SvgIcon);

    function NextWeek() {
      _classCallCheck(this, NextWeek);

      return _possibleConstructorReturn(this, _getPrototypeOf(NextWeek).apply(this, arguments));
    }

    _createClass(NextWeek, [{
      key: "renderSVG",
