define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AddCircle, _SvgIcon);

    function AddCircle() {
      _classCallCheck(this, AddCircle);

      return _possibleConstructorReturn(this, _getPrototypeOf(AddCircle).apply(this, arguments));
    }
    ...
    _createClass(AddCircle, [{
      ...
      key: "is",
      get: function get() {
        return 'material.content.AddCircle';
      }
    }]);
