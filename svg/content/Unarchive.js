define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Unarchive, _SvgIcon);

    function Unarchive() {
      _classCallCheck(this, Unarchive);

      return _possibleConstructorReturn(this, _getPrototypeOf(Unarchive).apply(this, arguments));
    }

    _createClass(Unarchive, [{
      key: "renderSVG",
