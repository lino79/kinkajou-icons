define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Explicit, _SvgIcon);

    function Explicit() {
      _classCallCheck(this, Explicit);

      return _possibleConstructorReturn(this, _getPrototypeOf(Explicit).apply(this, arguments));
    }
