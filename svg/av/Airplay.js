define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Airplay, _SvgIcon);

    function Airplay() {
      _classCallCheck(this, Airplay);

      return _possibleConstructorReturn(this, _getPrototypeOf(Airplay).apply(this, arguments));
    }
