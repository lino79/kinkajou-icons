define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Subtitles, _SvgIcon);

    function Subtitles() {
      _classCallCheck(this, Subtitles);

      return _possibleConstructorReturn(this, _getPrototypeOf(Subtitles).apply(this, arguments));
    }
