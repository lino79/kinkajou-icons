define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FastForward, _SvgIcon);

    function FastForward() {
      _classCallCheck(this, FastForward);

      return _possibleConstructorReturn(this, _getPrototypeOf(FastForward).apply(this, arguments));
    }

    _createClass(FastForward, [{
      key: "renderSVG",
  ...
  _exports.FastForward = FastForward;
});
