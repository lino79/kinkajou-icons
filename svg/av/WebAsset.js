define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(WebAsset, _SvgIcon);

    function WebAsset() {
      _classCallCheck(this, WebAsset);

      return _possibleConstructorReturn(this, _getPrototypeOf(WebAsset).apply(this, arguments));
    }

    _createClass(WebAsset, [{
      key: "renderSVG",
  ...
  _exports.WebAsset = WebAsset;
});
//# sourceMappingURL=WebAsset.js.map