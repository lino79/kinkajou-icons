define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(HighQuality, _SvgIcon);

    function HighQuality() {
      _classCallCheck(this, HighQuality);

      return _possibleConstructorReturn(this, _getPrototypeOf(HighQuality).apply(this, arguments));
    }

    _createClass(HighQuality, [{
      key: "renderSVG",
  ...
  _exports.HighQuality = HighQuality;
});
//# sourceMappingURL=HighQuality.js.map