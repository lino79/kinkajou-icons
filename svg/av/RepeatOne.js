define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(RepeatOne, _SvgIcon);

    function RepeatOne() {
      _classCallCheck(this, RepeatOne);

      return _possibleConstructorReturn(this, _getPrototypeOf(RepeatOne).apply(this, arguments));
    }

    _createClass(RepeatOne, [{
      key: "renderSVG",
