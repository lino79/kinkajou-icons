define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Subscriptions, _SvgIcon);

    function Subscriptions() {
      _classCallCheck(this, Subscriptions);

      return _possibleConstructorReturn(this, _getPrototypeOf(Subscriptions).apply(this, arguments));
    }
  ...
  _exports.Subscriptions = Subscriptions;
});
