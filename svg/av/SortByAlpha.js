define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SortByAlpha, _SvgIcon);

    function SortByAlpha() {
      _classCallCheck(this, SortByAlpha);

      return _possibleConstructorReturn(this, _getPrototypeOf(SortByAlpha).apply(this, arguments));
    }

    _createClass(SortByAlpha, [{
      key: "renderSVG",
  ...
  _exports.SortByAlpha = SortByAlpha;
});
//# sourceMappingURL=SortByAlpha.js.map