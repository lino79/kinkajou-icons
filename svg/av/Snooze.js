define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Snooze, _SvgIcon);

    function Snooze() {
      _classCallCheck(this, Snooze);

      return _possibleConstructorReturn(this, _getPrototypeOf(Snooze).apply(this, arguments));
    }
