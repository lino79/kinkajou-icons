define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LibraryMusic, _SvgIcon);

    function LibraryMusic() {
      _classCallCheck(this, LibraryMusic);

      return _possibleConstructorReturn(this, _getPrototypeOf(LibraryMusic).apply(this, arguments));
    }

    _createClass(LibraryMusic, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.av.LibraryMusic';
      }
    }]);
  ...
  _exports.LibraryMusic = LibraryMusic;
});
//# sourceMappingURL=LibraryMusic.js.map