define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ArtTrack, _SvgIcon);

    function ArtTrack() {
      _classCallCheck(this, ArtTrack);

      return _possibleConstructorReturn(this, _getPrototypeOf(ArtTrack).apply(this, arguments));
    }

    _createClass(ArtTrack, [{
      key: "renderSVG",
  ...
  _exports.ArtTrack = ArtTrack;
});
//# sourceMappingURL=ArtTrack.js.map