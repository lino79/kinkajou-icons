define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FiberDvr, _SvgIcon);

    function FiberDvr() {
      _classCallCheck(this, FiberDvr);

      return _possibleConstructorReturn(this, _getPrototypeOf(FiberDvr).apply(this, arguments));
    }

    _createClass(FiberDvr, [{
      key: "renderSVG",
  ...
  _exports.FiberDvr = FiberDvr;
});
//# sourceMappingURL=FiberDvr.js.map