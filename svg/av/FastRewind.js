define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FastRewind, _SvgIcon);

    function FastRewind() {
      _classCallCheck(this, FastRewind);

      return _possibleConstructorReturn(this, _getPrototypeOf(FastRewind).apply(this, arguments));
    }

    _createClass(FastRewind, [{
      key: "renderSVG",
  ...
  _exports.FastRewind = FastRewind;
});
//# sourceMappingURL=FastRewind.js.map