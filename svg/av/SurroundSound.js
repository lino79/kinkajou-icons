define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SurroundSound, _SvgIcon);

    function SurroundSound() {
      _classCallCheck(this, SurroundSound);

      return _possibleConstructorReturn(this, _getPrototypeOf(SurroundSound).apply(this, arguments));
    }

    _createClass(SurroundSound, [{
      key: "renderSVG",
  ...
  _exports.SurroundSound = SurroundSound;
});
