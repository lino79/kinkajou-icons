define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(NewReleases, _SvgIcon);

    function NewReleases() {
      _classCallCheck(this, NewReleases);

      return _possibleConstructorReturn(this, _getPrototypeOf(NewReleases).apply(this, arguments));
    }
  ...
  _exports.NewReleases = NewReleases;
});
//# sourceMappingURL=NewReleases.js.map