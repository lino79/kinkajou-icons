define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.PlaylistAddCheck = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PlaylistAddCheck, _SvgIcon);

    function PlaylistAddCheck() {
      _classCallCheck(this, PlaylistAddCheck);

      return _possibleConstructorReturn(this, _getPrototypeOf(PlaylistAddCheck).apply(this, arguments));
    }

    _createClass(PlaylistAddCheck, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.av.PlaylistAddCheck';
      }
    }]);
  ...
  _exports.PlaylistAddCheck = PlaylistAddCheck;
});
//# sourceMappingURL=PlaylistAddCheck.js.map