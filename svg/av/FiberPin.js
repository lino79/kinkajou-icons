define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FiberPin, _SvgIcon);

    function FiberPin() {
      _classCallCheck(this, FiberPin);

      return _possibleConstructorReturn(this, _getPrototypeOf(FiberPin).apply(this, arguments));
    }

    _createClass(FiberPin, [{
      key: "renderSVG",
  ...
  _exports.FiberPin = FiberPin;
});
//# sourceMappingURL=FiberPin.js.map