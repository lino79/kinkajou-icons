define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(VideoLibrary, _SvgIcon);

    function VideoLibrary() {
      _classCallCheck(this, VideoLibrary);

      return _possibleConstructorReturn(this, _getPrototypeOf(VideoLibrary).apply(this, arguments));
    }
    ...
    _createClass(VideoLibrary, [{
      ...
      key: "is",
      get: function get() {
        return 'material.av.VideoLibrary';
      }
    }]);
  ...
  _exports.VideoLibrary = VideoLibrary;
});
