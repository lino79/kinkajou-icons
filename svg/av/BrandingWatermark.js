define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.BrandingWatermark = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BrandingWatermark, _SvgIcon);

    function BrandingWatermark() {
      _classCallCheck(this, BrandingWatermark);

      return _possibleConstructorReturn(this, _getPrototypeOf(BrandingWatermark).apply(this, arguments));
    }

    _createClass(BrandingWatermark, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.av.BrandingWatermark';
      }
    }]);
  ...
  _exports.BrandingWatermark = BrandingWatermark;
});
//# sourceMappingURL=BrandingWatermark.js.map