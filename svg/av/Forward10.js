define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Forward10, _SvgIcon);

    function Forward10() {
      _classCallCheck(this, Forward10);

      return _possibleConstructorReturn(this, _getPrototypeOf(Forward10).apply(this, arguments));
    }

    _createClass(Forward10, [{
      key: "renderSVG",
