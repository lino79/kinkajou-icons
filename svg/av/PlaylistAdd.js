define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PlaylistAdd, _SvgIcon);

    function PlaylistAdd() {
      _classCallCheck(this, PlaylistAdd);

      return _possibleConstructorReturn(this, _getPrototypeOf(PlaylistAdd).apply(this, arguments));
    }

    _createClass(PlaylistAdd, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.av.PlaylistAdd';
      }
    }]);
  ...
  _exports.PlaylistAdd = PlaylistAdd;
});
