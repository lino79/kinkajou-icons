define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PlaylistPlay, _SvgIcon);

    function PlaylistPlay() {
      _classCallCheck(this, PlaylistPlay);

      return _possibleConstructorReturn(this, _getPrototypeOf(PlaylistPlay).apply(this, arguments));
    }

    _createClass(PlaylistPlay, [{
      key: "renderSVG",
  ...
  _exports.PlaylistPlay = PlaylistPlay;
});
//# sourceMappingURL=PlaylistPlay.js.map