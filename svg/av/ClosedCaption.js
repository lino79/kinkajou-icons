define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ClosedCaption, _SvgIcon);

    function ClosedCaption() {
      _classCallCheck(this, ClosedCaption);

      return _possibleConstructorReturn(this, _getPrototypeOf(ClosedCaption).apply(this, arguments));
    }
  ...
  _exports.ClosedCaption = ClosedCaption;
});
