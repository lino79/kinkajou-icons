define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SlowMotionVideo = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SlowMotionVideo, _SvgIcon);

    function SlowMotionVideo() {
      _classCallCheck(this, SlowMotionVideo);

      return _possibleConstructorReturn(this, _getPrototypeOf(SlowMotionVideo).apply(this, arguments));
    }

    _createClass(SlowMotionVideo, [{
      key: "renderSVG",
  ...
  _exports.SlowMotionVideo = SlowMotionVideo;
});
//# sourceMappingURL=SlowMotionVideo.js.map