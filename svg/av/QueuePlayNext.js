define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(QueuePlayNext, _SvgIcon);

    function QueuePlayNext() {
      _classCallCheck(this, QueuePlayNext);

      return _possibleConstructorReturn(this, _getPrototypeOf(QueuePlayNext).apply(this, arguments));
    }

    _createClass(QueuePlayNext, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.av.QueuePlayNext';
      }
    }]);
  ...
  _exports.QueuePlayNext = QueuePlayNext;
});
//# sourceMappingURL=QueuePlayNext.js.map