define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(VideoCall, _SvgIcon);

    function VideoCall() {
      _classCallCheck(this, VideoCall);

      return _possibleConstructorReturn(this, _getPrototypeOf(VideoCall).apply(this, arguments));
    }
