define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(MicNone, _SvgIcon);

    function MicNone() {
      _classCallCheck(this, MicNone);

      return _possibleConstructorReturn(this, _getPrototypeOf(MicNone).apply(this, arguments));
    }

    _createClass(MicNone, [{
      key: "renderSVG",
  ...
  _exports.MicNone = MicNone;
});
//# sourceMappingURL=MicNone.js.map