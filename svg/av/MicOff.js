define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(MicOff, _SvgIcon);

    function MicOff() {
      _classCallCheck(this, MicOff);

      return _possibleConstructorReturn(this, _getPrototypeOf(MicOff).apply(this, arguments));
    }
