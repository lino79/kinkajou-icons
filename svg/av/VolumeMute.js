define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(VolumeMute, _SvgIcon);

    function VolumeMute() {
      _classCallCheck(this, VolumeMute);

      return _possibleConstructorReturn(this, _getPrototypeOf(VolumeMute).apply(this, arguments));
    }
  ...
  _exports.VolumeMute = VolumeMute;
});
