define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Replay10, _SvgIcon);

    function Replay10() {
      _classCallCheck(this, Replay10);

      return _possibleConstructorReturn(this, _getPrototypeOf(Replay10).apply(this, arguments));
    }

    _createClass(Replay10, [{
      key: "renderSVG",
