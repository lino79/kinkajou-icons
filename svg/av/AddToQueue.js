define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AddToQueue, _SvgIcon);

    function AddToQueue() {
      _classCallCheck(this, AddToQueue);

      return _possibleConstructorReturn(this, _getPrototypeOf(AddToQueue).apply(this, arguments));
    }
  ...
  _exports.AddToQueue = AddToQueue;
});
