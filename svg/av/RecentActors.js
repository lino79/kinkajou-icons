define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(RecentActors, _SvgIcon);

    function RecentActors() {
      _classCallCheck(this, RecentActors);

      return _possibleConstructorReturn(this, _getPrototypeOf(RecentActors).apply(this, arguments));
    }

    _createClass(RecentActors, [{
      key: "renderSVG",
  ...
  _exports.RecentActors = RecentActors;
});
//# sourceMappingURL=RecentActors.js.map