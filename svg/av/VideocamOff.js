define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(VideocamOff, _SvgIcon);

    function VideocamOff() {
      _classCallCheck(this, VideocamOff);

      return _possibleConstructorReturn(this, _getPrototypeOf(VideocamOff).apply(this, arguments));
    }

    _createClass(VideocamOff, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.av.VideocamOff';
      }
    }]);
  ...
  _exports.VideocamOff = VideocamOff;
});
