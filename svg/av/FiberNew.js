define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FiberNew, _SvgIcon);

    function FiberNew() {
      _classCallCheck(this, FiberNew);

      return _possibleConstructorReturn(this, _getPrototypeOf(FiberNew).apply(this, arguments));
    }

    _createClass(FiberNew, [{
      key: "renderSVG",
  ...
  _exports.FiberNew = FiberNew;
});
//# sourceMappingURL=FiberNew.js.map