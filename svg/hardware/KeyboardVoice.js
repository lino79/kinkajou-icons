define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(KeyboardVoice, _SvgIcon);

    function KeyboardVoice() {
      _classCallCheck(this, KeyboardVoice);

      return _possibleConstructorReturn(this, _getPrototypeOf(KeyboardVoice).apply(this, arguments));
    }

    _createClass(KeyboardVoice, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.hardware.KeyboardVoice';
      }
    }]);

    return KeyboardVoice;
  }(_SvgIcon2.SvgIcon);

  _exports.KeyboardVoice = KeyboardVoice;
});
//# sourceMappingURL=KeyboardVoice.js.map