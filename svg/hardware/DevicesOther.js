define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(DevicesOther, _SvgIcon);

    function DevicesOther() {
      _classCallCheck(this, DevicesOther);

      return _possibleConstructorReturn(this, _getPrototypeOf(DevicesOther).apply(this, arguments));
    }

    _createClass(DevicesOther, [{
      key: "renderSVG",
  ...
  _exports.DevicesOther = DevicesOther;
});
//# sourceMappingURL=DevicesOther.js.map