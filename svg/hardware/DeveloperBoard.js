define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.DeveloperBoard = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(DeveloperBoard, _SvgIcon);

    function DeveloperBoard() {
      _classCallCheck(this, DeveloperBoard);

      return _possibleConstructorReturn(this, _getPrototypeOf(DeveloperBoard).apply(this, arguments));
    }

    _createClass(DeveloperBoard, [{
      key: "renderSVG",
  ...
  _exports.DeveloperBoard = DeveloperBoard;
});
