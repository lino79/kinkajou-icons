define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(HeadsetMic, _SvgIcon);

    function HeadsetMic() {
      _classCallCheck(this, HeadsetMic);

      return _possibleConstructorReturn(this, _getPrototypeOf(HeadsetMic).apply(this, arguments));
    }

    _createClass(HeadsetMic, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.hardware.HeadsetMic';
      }
    }]);
  ...
  _exports.HeadsetMic = HeadsetMic;
});
