define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(TabletMac, _SvgIcon);

    function TabletMac() {
      _classCallCheck(this, TabletMac);

      return _possibleConstructorReturn(this, _getPrototypeOf(TabletMac).apply(this, arguments));
    }

    _createClass(TabletMac, [{
      key: "renderSVG",
