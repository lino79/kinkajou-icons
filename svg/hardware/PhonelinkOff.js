define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PhonelinkOff, _SvgIcon);

    function PhonelinkOff() {
      _classCallCheck(this, PhonelinkOff);

      return _possibleConstructorReturn(this, _getPrototypeOf(PhonelinkOff).apply(this, arguments));
    }

    _createClass(PhonelinkOff, [{
      key: "renderSVG",
  ...
  _exports.PhonelinkOff = PhonelinkOff;
});
//# sourceMappingURL=PhonelinkOff.js.map