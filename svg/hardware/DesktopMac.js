define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(DesktopMac, _SvgIcon);

    function DesktopMac() {
      _classCallCheck(this, DesktopMac);

      return _possibleConstructorReturn(this, _getPrototypeOf(DesktopMac).apply(this, arguments));
    }

    _createClass(DesktopMac, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.hardware.DesktopMac';
      }
    }]);
  ...
  _exports.DesktopMac = DesktopMac;
});
//# sourceMappingURL=DesktopMac.js.map