define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(KeyboardTab, _SvgIcon);

    function KeyboardTab() {
      _classCallCheck(this, KeyboardTab);

      return _possibleConstructorReturn(this, _getPrototypeOf(KeyboardTab).apply(this, arguments));
    }

    _createClass(KeyboardTab, [{
      key: "renderSVG",
  ...
  _exports.KeyboardTab = KeyboardTab;
});
