define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.KeyboardArrowLeft = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(KeyboardArrowLeft, _SvgIcon);

    function KeyboardArrowLeft() {
      _classCallCheck(this, KeyboardArrowLeft);

      return _possibleConstructorReturn(this, _getPrototypeOf(KeyboardArrowLeft).apply(this, arguments));
    }

    _createClass(KeyboardArrowLeft, [{
      key: "renderSVG",
  ...
  _exports.KeyboardArrowLeft = KeyboardArrowLeft;
});
