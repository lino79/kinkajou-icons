define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Scanner, _SvgIcon);

    function Scanner() {
      _classCallCheck(this, Scanner);

      return _possibleConstructorReturn(this, _getPrototypeOf(Scanner).apply(this, arguments));
    }
