define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LaptopMac, _SvgIcon);

    function LaptopMac() {
      _classCallCheck(this, LaptopMac);

      return _possibleConstructorReturn(this, _getPrototypeOf(LaptopMac).apply(this, arguments));
    }

    _createClass(LaptopMac, [{
      key: "renderSVG",
