define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CastConnected, _SvgIcon);

    function CastConnected() {
      _classCallCheck(this, CastConnected);

      return _possibleConstructorReturn(this, _getPrototypeOf(CastConnected).apply(this, arguments));
    }

    _createClass(CastConnected, [{
      key: "renderSVG",
  ...
  _exports.CastConnected = CastConnected;
});
