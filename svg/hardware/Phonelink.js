define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Phonelink, _SvgIcon);

    function Phonelink() {
      _classCallCheck(this, Phonelink);

      return _possibleConstructorReturn(this, _getPrototypeOf(Phonelink).apply(this, arguments));
    }
