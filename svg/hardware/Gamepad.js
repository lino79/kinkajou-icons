define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Gamepad, _SvgIcon);

    function Gamepad() {
      _classCallCheck(this, Gamepad);

      return _possibleConstructorReturn(this, _getPrototypeOf(Gamepad).apply(this, arguments));
    }
    ...
    _createClass(Gamepad, [{
      ...
      key: "is",
      get: function get() {
        return 'material.hardware.Gamepad';
      }
    }]);
