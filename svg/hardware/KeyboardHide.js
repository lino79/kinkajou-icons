define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(KeyboardHide, _SvgIcon);

    function KeyboardHide() {
      _classCallCheck(this, KeyboardHide);

      return _possibleConstructorReturn(this, _getPrototypeOf(KeyboardHide).apply(this, arguments));
    }

    _createClass(KeyboardHide, [{
      key: "renderSVG",
  ...
  _exports.KeyboardHide = KeyboardHide;
});
