define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PowerInput, _SvgIcon);

    function PowerInput() {
      _classCallCheck(this, PowerInput);

      return _possibleConstructorReturn(this, _getPrototypeOf(PowerInput).apply(this, arguments));
    }

    _createClass(PowerInput, [{
      key: "renderSVG",
  ...
  _exports.PowerInput = PowerInput;
});
//# sourceMappingURL=PowerInput.js.map