define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(DeviceHub, _SvgIcon);

    function DeviceHub() {
      _classCallCheck(this, DeviceHub);

      return _possibleConstructorReturn(this, _getPrototypeOf(DeviceHub).apply(this, arguments));
    }

    _createClass(DeviceHub, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.hardware.DeviceHub';
      }
    }]);
