define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Tablet, _SvgIcon);

    function Tablet() {
      _classCallCheck(this, Tablet);

      return _possibleConstructorReturn(this, _getPrototypeOf(Tablet).apply(this, arguments));
    }
    ...
    _createClass(Tablet, [{
      ...
      key: "is",
      get: function get() {
        return 'material.hardware.Tablet';
      }
    }]);
