define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.KeyboardArrowRight = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(KeyboardArrowRight, _SvgIcon);

    function KeyboardArrowRight() {
      _classCallCheck(this, KeyboardArrowRight);

      return _possibleConstructorReturn(this, _getPrototypeOf(KeyboardArrowRight).apply(this, arguments));
    }

    _createClass(KeyboardArrowRight, [{
      key: "renderSVG",
  ...
  _exports.KeyboardArrowRight = KeyboardArrowRight;
});
