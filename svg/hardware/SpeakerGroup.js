define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SpeakerGroup, _SvgIcon);

    function SpeakerGroup() {
      _classCallCheck(this, SpeakerGroup);

      return _possibleConstructorReturn(this, _getPrototypeOf(SpeakerGroup).apply(this, arguments));
    }

    _createClass(SpeakerGroup, [{
      key: "renderSVG",
  ...
  _exports.SpeakerGroup = SpeakerGroup;
});
//# sourceMappingURL=SpeakerGroup.js.map