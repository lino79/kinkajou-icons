define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ArrowDropUp, _SvgIcon);

    function ArrowDropUp() {
      _classCallCheck(this, ArrowDropUp);

      return _possibleConstructorReturn(this, _getPrototypeOf(ArrowDropUp).apply(this, arguments));
    }

    _createClass(ArrowDropUp, [{
      key: "renderSVG",
  ...
  _exports.ArrowDropUp = ArrowDropUp;
});
