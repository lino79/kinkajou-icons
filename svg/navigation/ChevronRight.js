define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ChevronRight, _SvgIcon);

    function ChevronRight() {
      _classCallCheck(this, ChevronRight);

      return _possibleConstructorReturn(this, _getPrototypeOf(ChevronRight).apply(this, arguments));
    }

    _createClass(ChevronRight, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.navigation.ChevronRight';
      }
    }]);
  ...
  _exports.ChevronRight = ChevronRight;
});
