define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LastPage, _SvgIcon);

    function LastPage() {
      _classCallCheck(this, LastPage);

      return _possibleConstructorReturn(this, _getPrototypeOf(LastPage).apply(this, arguments));
    }
