define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ArrowDownward, _SvgIcon);

    function ArrowDownward() {
      _classCallCheck(this, ArrowDownward);

      return _possibleConstructorReturn(this, _getPrototypeOf(ArrowDownward).apply(this, arguments));
    }

    _createClass(ArrowDownward, [{
      key: "renderSVG",
  ...
  _exports.ArrowDownward = ArrowDownward;
});
