define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ArrowDropDown, _SvgIcon);

    function ArrowDropDown() {
      _classCallCheck(this, ArrowDropDown);

      return _possibleConstructorReturn(this, _getPrototypeOf(ArrowDropDown).apply(this, arguments));
    }

    _createClass(ArrowDropDown, [{
      key: "renderSVG",
  ...
  _exports.ArrowDropDown = ArrowDropDown;
});
