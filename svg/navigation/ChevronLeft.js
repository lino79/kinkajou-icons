define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ChevronLeft, _SvgIcon);

    function ChevronLeft() {
      _classCallCheck(this, ChevronLeft);

      return _possibleConstructorReturn(this, _getPrototypeOf(ChevronLeft).apply(this, arguments));
    }
  ...
  _exports.ChevronLeft = ChevronLeft;
});
