define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ExpandMore, _SvgIcon);

    function ExpandMore() {
      _classCallCheck(this, ExpandMore);

      return _possibleConstructorReturn(this, _getPrototypeOf(ExpandMore).apply(this, arguments));
    }

    _createClass(ExpandMore, [{
      key: "renderSVG",
  ...
  _exports.ExpandMore = ExpandMore;
});
