define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ArrowBack, _SvgIcon);

    function ArrowBack() {
      _classCallCheck(this, ArrowBack);

      return _possibleConstructorReturn(this, _getPrototypeOf(ArrowBack).apply(this, arguments));
    }

    _createClass(ArrowBack, [{
      key: "renderSVG",
