define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FlipToFront, _SvgIcon);

    function FlipToFront() {
      _classCallCheck(this, FlipToFront);

      return _possibleConstructorReturn(this, _getPrototypeOf(FlipToFront).apply(this, arguments));
    }

    _createClass(FlipToFront, [{
      key: "renderSVG",
  ...
  _exports.FlipToFront = FlipToFront;
});
