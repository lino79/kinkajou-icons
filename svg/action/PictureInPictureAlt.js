define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.PictureInPictureAlt = void 0;
  ...
  var PictureInPictureAlt =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PictureInPictureAlt, _SvgIcon);

    function PictureInPictureAlt() {
      _classCallCheck(this, PictureInPictureAlt);

      return _possibleConstructorReturn(this, _getPrototypeOf(PictureInPictureAlt).apply(this, arguments));
    }

    _createClass(PictureInPictureAlt, [{
      key: "renderSVG",
  ...
  _exports.PictureInPictureAlt = PictureInPictureAlt;
});
