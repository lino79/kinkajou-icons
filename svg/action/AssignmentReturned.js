define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.AssignmentReturned = void 0;
  ...
  var AssignmentReturned =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AssignmentReturned, _SvgIcon);

    function AssignmentReturned() {
      _classCallCheck(this, AssignmentReturned);

      return _possibleConstructorReturn(this, _getPrototypeOf(AssignmentReturned).apply(this, arguments));
    }

    _createClass(AssignmentReturned, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.AssignmentReturned';
      }
    }]);
  ...
  _exports.AssignmentReturned = AssignmentReturned;
});
