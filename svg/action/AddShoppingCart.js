define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.AddShoppingCart = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AddShoppingCart, _SvgIcon);

    function AddShoppingCart() {
      _classCallCheck(this, AddShoppingCart);

      return _possibleConstructorReturn(this, _getPrototypeOf(AddShoppingCart).apply(this, arguments));
    }
  ...
  _exports.AddShoppingCart = AddShoppingCart;
});
