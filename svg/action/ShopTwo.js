define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ShopTwo, _SvgIcon);

    function ShopTwo() {
      _classCallCheck(this, ShopTwo);

      return _possibleConstructorReturn(this, _getPrototypeOf(ShopTwo).apply(this, arguments));
    }

    _createClass(ShopTwo, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.ShopTwo';
      }
    }]);
  ...
  _exports.ShopTwo = ShopTwo;
});
//# sourceMappingURL=ShopTwo.js.map