define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SettingsBluetooth = void 0;
  ...
  var SettingsBluetooth =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SettingsBluetooth, _SvgIcon);

    function SettingsBluetooth() {
      _classCallCheck(this, SettingsBluetooth);

      return _possibleConstructorReturn(this, _getPrototypeOf(SettingsBluetooth).apply(this, arguments));
    }

    _createClass(SettingsBluetooth, [{
      key: "renderSVG",
  ...
  _exports.SettingsBluetooth = SettingsBluetooth;
});
//# sourceMappingURL=SettingsBluetooth.js.map