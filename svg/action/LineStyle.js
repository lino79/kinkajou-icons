define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LineStyle, _SvgIcon);

    function LineStyle() {
      _classCallCheck(this, LineStyle);

      return _possibleConstructorReturn(this, _getPrototypeOf(LineStyle).apply(this, arguments));
    }
