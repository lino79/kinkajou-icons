define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(InvertColors, _SvgIcon);

    function InvertColors() {
      _classCallCheck(this, InvertColors);

      return _possibleConstructorReturn(this, _getPrototypeOf(InvertColors).apply(this, arguments));
    }

    _createClass(InvertColors, [{
      key: "renderSVG",
  ...
  _exports.InvertColors = InvertColors;
});
