define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.AssignmentReturn = void 0;
  ...
  var AssignmentReturn =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AssignmentReturn, _SvgIcon);

    function AssignmentReturn() {
      _classCallCheck(this, AssignmentReturn);

      return _possibleConstructorReturn(this, _getPrototypeOf(AssignmentReturn).apply(this, arguments));
    }

    _createClass(AssignmentReturn, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.AssignmentReturn';
      }
    }]);
  ...
  _exports.AssignmentReturn = AssignmentReturn;
});
