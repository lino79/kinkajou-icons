define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FindReplace, _SvgIcon);

    function FindReplace() {
      _classCallCheck(this, FindReplace);

      return _possibleConstructorReturn(this, _getPrototypeOf(FindReplace).apply(this, arguments));
    }
  ...
  _exports.FindReplace = FindReplace;
});
