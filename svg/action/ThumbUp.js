define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ThumbUp, _SvgIcon);

    function ThumbUp() {
      _classCallCheck(this, ThumbUp);

      return _possibleConstructorReturn(this, _getPrototypeOf(ThumbUp).apply(this, arguments));
    }
