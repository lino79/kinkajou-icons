define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(TrackChanges, _SvgIcon);

    function TrackChanges() {
      _classCallCheck(this, TrackChanges);

      return _possibleConstructorReturn(this, _getPrototypeOf(TrackChanges).apply(this, arguments));
    }

    _createClass(TrackChanges, [{
      key: "renderSVG",
  ...
  _exports.TrackChanges = TrackChanges;
});
