define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(DonutLarge, _SvgIcon);

    function DonutLarge() {
      _classCallCheck(this, DonutLarge);

      return _possibleConstructorReturn(this, _getPrototypeOf(DonutLarge).apply(this, arguments));
    }

    _createClass(DonutLarge, [{
      key: "renderSVG",
  ...
  _exports.DonutLarge = DonutLarge;
});
//# sourceMappingURL=DonutLarge.js.map