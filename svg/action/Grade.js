define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Grade, _SvgIcon);

    function Grade() {
      _classCallCheck(this, Grade);

      return _possibleConstructorReturn(this, _getPrototypeOf(Grade).apply(this, arguments));
    }
