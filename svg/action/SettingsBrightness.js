define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SettingsBrightness = void 0;
  ...
  var SettingsBrightness =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SettingsBrightness, _SvgIcon);

    function SettingsBrightness() {
      _classCallCheck(this, SettingsBrightness);

      return _possibleConstructorReturn(this, _getPrototypeOf(SettingsBrightness).apply(this, arguments));
    }

    _createClass(SettingsBrightness, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.SettingsBrightness';
      }
    }]);
  ...
  _exports.SettingsBrightness = SettingsBrightness;
});
//# sourceMappingURL=SettingsBrightness.js.map