define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Theaters, _SvgIcon);

    function Theaters() {
      _classCallCheck(this, Theaters);

      return _possibleConstructorReturn(this, _getPrototypeOf(Theaters).apply(this, arguments));
    }
