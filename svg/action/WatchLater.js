define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(WatchLater, _SvgIcon);

    function WatchLater() {
      _classCallCheck(this, WatchLater);

      return _possibleConstructorReturn(this, _getPrototypeOf(WatchLater).apply(this, arguments));
    }
    ...
    _createClass(WatchLater, [{
      ...
      key: "is",
      get: function get() {
        return 'material.action.WatchLater';
      }
    }]);
  ...
  _exports.WatchLater = WatchLater;
});
