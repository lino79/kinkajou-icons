define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ViewDay, _SvgIcon);

    function ViewDay() {
      _classCallCheck(this, ViewDay);

      return _possibleConstructorReturn(this, _getPrototypeOf(ViewDay).apply(this, arguments));
    }

    _createClass(ViewDay, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.ViewDay';
      }
    }]);
