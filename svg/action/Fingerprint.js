define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Fingerprint, _SvgIcon);

    function Fingerprint() {
      _classCallCheck(this, Fingerprint);

      return _possibleConstructorReturn(this, _getPrototypeOf(Fingerprint).apply(this, arguments));
    }
    ...
    _createClass(Fingerprint, [{
      ...
      key: "is",
      get: function get() {
        return 'material.action.Fingerprint';
      }
    }]);
  ...
  _exports.Fingerprint = Fingerprint;
});
