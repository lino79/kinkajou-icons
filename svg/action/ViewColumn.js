define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ViewColumn, _SvgIcon);

    function ViewColumn() {
      _classCallCheck(this, ViewColumn);

      return _possibleConstructorReturn(this, _getPrototypeOf(ViewColumn).apply(this, arguments));
    }

    _createClass(ViewColumn, [{
      key: "renderSVG",
  ...
  _exports.ViewColumn = ViewColumn;
});
