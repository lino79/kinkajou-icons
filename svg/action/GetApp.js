define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(GetApp, _SvgIcon);

    function GetApp() {
      _classCallCheck(this, GetApp);

      return _possibleConstructorReturn(this, _getPrototypeOf(GetApp).apply(this, arguments));
    }
