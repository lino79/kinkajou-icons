define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SwapVert, _SvgIcon);

    function SwapVert() {
      _classCallCheck(this, SwapVert);

      return _possibleConstructorReturn(this, _getPrototypeOf(SwapVert).apply(this, arguments));
    }

    _createClass(SwapVert, [{
      key: "renderSVG",
