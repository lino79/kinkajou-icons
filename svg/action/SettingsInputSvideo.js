define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SettingsInputSvideo = void 0;
  ...
  var SettingsInputSvideo =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SettingsInputSvideo, _SvgIcon);

    function SettingsInputSvideo() {
      _classCallCheck(this, SettingsInputSvideo);

      return _possibleConstructorReturn(this, _getPrototypeOf(SettingsInputSvideo).apply(this, arguments));
    }

    _createClass(SettingsInputSvideo, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.SettingsInputSvideo';
      }
    }]);
  ...
  _exports.SettingsInputSvideo = SettingsInputSvideo;
});
//# sourceMappingURL=SettingsInputSvideo.js.map