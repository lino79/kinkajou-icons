define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.PermContactCalendar = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PermContactCalendar, _SvgIcon);

    function PermContactCalendar() {
      _classCallCheck(this, PermContactCalendar);

      return _possibleConstructorReturn(this, _getPrototypeOf(PermContactCalendar).apply(this, arguments));
    }

    _createClass(PermContactCalendar, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.PermContactCalendar';
      }
    }]);
  ...
  _exports.PermContactCalendar = PermContactCalendar;
});
//# sourceMappingURL=PermContactCalendar.js.map