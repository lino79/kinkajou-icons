define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.ImportantDevices = void 0;
  ...
  var ImportantDevices =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ImportantDevices, _SvgIcon);

    function ImportantDevices() {
      _classCallCheck(this, ImportantDevices);

      return _possibleConstructorReturn(this, _getPrototypeOf(ImportantDevices).apply(this, arguments));
    }

    _createClass(ImportantDevices, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.ImportantDevices';
      }
    }]);
  ...
  _exports.ImportantDevices = ImportantDevices;
});
//# sourceMappingURL=ImportantDevices.js.map