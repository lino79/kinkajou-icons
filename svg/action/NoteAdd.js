define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(NoteAdd, _SvgIcon);

    function NoteAdd() {
      _classCallCheck(this, NoteAdd);

      return _possibleConstructorReturn(this, _getPrototypeOf(NoteAdd).apply(this, arguments));
    }

    _createClass(NoteAdd, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.NoteAdd';
      }
    }]);
