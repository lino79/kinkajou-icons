define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(GTranslate, _SvgIcon);

    function GTranslate() {
      _classCallCheck(this, GTranslate);

      return _possibleConstructorReturn(this, _getPrototypeOf(GTranslate).apply(this, arguments));
    }

    _createClass(GTranslate, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.GTranslate';
      }
    }]);
  ...
  _exports.GTranslate = GTranslate;
});
