define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Motorcycle, _SvgIcon);

    function Motorcycle() {
      _classCallCheck(this, Motorcycle);

      return _possibleConstructorReturn(this, _getPrototypeOf(Motorcycle).apply(this, arguments));
    }
  ...
  _exports.Motorcycle = Motorcycle;
});
