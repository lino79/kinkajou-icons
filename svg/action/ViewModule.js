define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ViewModule, _SvgIcon);

    function ViewModule() {
      _classCallCheck(this, ViewModule);

      return _possibleConstructorReturn(this, _getPrototypeOf(ViewModule).apply(this, arguments));
    }
    ...
    _createClass(ViewModule, [{
      ...
      key: "is",
      get: function get() {
        return 'material.action.ViewModule';
      }
    }]);
  ...
  _exports.ViewModule = ViewModule;
});
