define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SettingsCell, _SvgIcon);

    function SettingsCell() {
      _classCallCheck(this, SettingsCell);

      return _possibleConstructorReturn(this, _getPrototypeOf(SettingsCell).apply(this, arguments));
    }

    _createClass(SettingsCell, [{
      key: "renderSVG",
  ...
  _exports.SettingsCell = SettingsCell;
});
//# sourceMappingURL=SettingsCell.js.map