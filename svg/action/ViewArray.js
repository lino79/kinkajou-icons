define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ViewArray, _SvgIcon);

    function ViewArray() {
      _classCallCheck(this, ViewArray);

      return _possibleConstructorReturn(this, _getPrototypeOf(ViewArray).apply(this, arguments));
    }

    _createClass(ViewArray, [{
      key: "renderSVG",
  ...
  _exports.ViewArray = ViewArray;
});
//# sourceMappingURL=ViewArray.js.map