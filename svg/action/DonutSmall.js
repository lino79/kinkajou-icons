define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(DonutSmall, _SvgIcon);

    function DonutSmall() {
      _classCallCheck(this, DonutSmall);

      return _possibleConstructorReturn(this, _getPrototypeOf(DonutSmall).apply(this, arguments));
    }

    _createClass(DonutSmall, [{
      key: "renderSVG",
  ...
  _exports.DonutSmall = DonutSmall;
});
//# sourceMappingURL=DonutSmall.js.map