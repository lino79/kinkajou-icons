define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Android, _SvgIcon);

    function Android() {
      _classCallCheck(this, Android);

      return _possibleConstructorReturn(this, _getPrototypeOf(Android).apply(this, arguments));
    }
