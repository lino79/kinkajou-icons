define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(TrendingUp, _SvgIcon);

    function TrendingUp() {
      _classCallCheck(this, TrendingUp);

      return _possibleConstructorReturn(this, _getPrototypeOf(TrendingUp).apply(this, arguments));
    }

    _createClass(TrendingUp, [{
      key: "renderSVG",
  ...
  _exports.TrendingUp = TrendingUp;
});
