define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Redeem, _SvgIcon);

    function Redeem() {
      _classCallCheck(this, Redeem);

      return _possibleConstructorReturn(this, _getPrototypeOf(Redeem).apply(this, arguments));
    }
