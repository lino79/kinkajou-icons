define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ChangeHistory, _SvgIcon);

    function ChangeHistory() {
      _classCallCheck(this, ChangeHistory);

      return _possibleConstructorReturn(this, _getPrototypeOf(ChangeHistory).apply(this, arguments));
    }
  ...
  _exports.ChangeHistory = ChangeHistory;
});
