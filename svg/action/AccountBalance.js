define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.AccountBalance = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AccountBalance, _SvgIcon);

    function AccountBalance() {
      _classCallCheck(this, AccountBalance);

      return _possibleConstructorReturn(this, _getPrototypeOf(AccountBalance).apply(this, arguments));
    }
    ...
    _createClass(AccountBalance, [{
      ...
      key: "is",
      get: function get() {
        return 'material.action.AccountBalance';
      }
    }]);
