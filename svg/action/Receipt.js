define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Receipt, _SvgIcon);

    function Receipt() {
      _classCallCheck(this, Receipt);

      return _possibleConstructorReturn(this, _getPrototypeOf(Receipt).apply(this, arguments));
    }
