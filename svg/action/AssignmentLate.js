define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.AssignmentLate = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AssignmentLate, _SvgIcon);

    function AssignmentLate() {
      _classCallCheck(this, AssignmentLate);

      return _possibleConstructorReturn(this, _getPrototypeOf(AssignmentLate).apply(this, arguments));
    }

    _createClass(AssignmentLate, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.AssignmentLate';
      }
    }]);
  ...
  _exports.AssignmentLate = AssignmentLate;
});
//# sourceMappingURL=AssignmentLate.js.map