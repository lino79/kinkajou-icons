define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(RoundedCorner, _SvgIcon);

    function RoundedCorner() {
      _classCallCheck(this, RoundedCorner);

      return _possibleConstructorReturn(this, _getPrototypeOf(RoundedCorner).apply(this, arguments));
    }

    _createClass(RoundedCorner, [{
      key: "renderSVG",
  ...
  _exports.RoundedCorner = RoundedCorner;
});
