define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(TrendingDown, _SvgIcon);

    function TrendingDown() {
      _classCallCheck(this, TrendingDown);

      return _possibleConstructorReturn(this, _getPrototypeOf(TrendingDown).apply(this, arguments));
    }

    _createClass(TrendingDown, [{
      key: "renderSVG",
  ...
  _exports.TrendingDown = TrendingDown;
});
