define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SettingsVoice, _SvgIcon);

    function SettingsVoice() {
      _classCallCheck(this, SettingsVoice);

      return _possibleConstructorReturn(this, _getPrototypeOf(SettingsVoice).apply(this, arguments));
    }

    _createClass(SettingsVoice, [{
      key: "renderSVG",
  ...
  _exports.SettingsVoice = SettingsVoice;
});
//# sourceMappingURL=SettingsVoice.js.map