define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Spellcheck, _SvgIcon);

    function Spellcheck() {
      _classCallCheck(this, Spellcheck);

      return _possibleConstructorReturn(this, _getPrototypeOf(Spellcheck).apply(this, arguments));
    }
  ...
  _exports.Spellcheck = Spellcheck;
});
