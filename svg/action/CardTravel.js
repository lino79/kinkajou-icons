define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CardTravel, _SvgIcon);

    function CardTravel() {
      _classCallCheck(this, CardTravel);

      return _possibleConstructorReturn(this, _getPrototypeOf(CardTravel).apply(this, arguments));
    }

    _createClass(CardTravel, [{
      key: "renderSVG",
  ...
  _exports.CardTravel = CardTravel;
});
