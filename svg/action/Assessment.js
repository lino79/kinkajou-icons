define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Assessment, _SvgIcon);

    function Assessment() {
      _classCallCheck(this, Assessment);

      return _possibleConstructorReturn(this, _getPrototypeOf(Assessment).apply(this, arguments));
    }
  ...
  _exports.Assessment = Assessment;
});
