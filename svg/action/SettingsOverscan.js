define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SettingsOverscan = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SettingsOverscan, _SvgIcon);

    function SettingsOverscan() {
      _classCallCheck(this, SettingsOverscan);

      return _possibleConstructorReturn(this, _getPrototypeOf(SettingsOverscan).apply(this, arguments));
    }

    _createClass(SettingsOverscan, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.SettingsOverscan';
      }
    }]);
  ...
  _exports.SettingsOverscan = SettingsOverscan;
});
//# sourceMappingURL=SettingsOverscan.js.map