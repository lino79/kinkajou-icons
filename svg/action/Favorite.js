define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Favorite, _SvgIcon);

    function Favorite() {
      _classCallCheck(this, Favorite);

      return _possibleConstructorReturn(this, _getPrototypeOf(Favorite).apply(this, arguments));
    }
