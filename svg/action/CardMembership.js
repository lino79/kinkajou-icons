define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.CardMembership = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CardMembership, _SvgIcon);

    function CardMembership() {
      _classCallCheck(this, CardMembership);

      return _possibleConstructorReturn(this, _getPrototypeOf(CardMembership).apply(this, arguments));
    }

    _createClass(CardMembership, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.CardMembership';
      }
    }]);
  ...
  _exports.CardMembership = CardMembership;
});
