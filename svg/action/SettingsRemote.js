define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SettingsRemote = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SettingsRemote, _SvgIcon);

    function SettingsRemote() {
      _classCallCheck(this, SettingsRemote);

      return _possibleConstructorReturn(this, _getPrototypeOf(SettingsRemote).apply(this, arguments));
    }

    _createClass(SettingsRemote, [{
      key: "renderSVG",
  ...
  _exports.SettingsRemote = SettingsRemote;
});
//# sourceMappingURL=SettingsRemote.js.map