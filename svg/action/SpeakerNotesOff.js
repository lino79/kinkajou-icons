define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SpeakerNotesOff = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SpeakerNotesOff, _SvgIcon);

    function SpeakerNotesOff() {
      _classCallCheck(this, SpeakerNotesOff);

      return _possibleConstructorReturn(this, _getPrototypeOf(SpeakerNotesOff).apply(this, arguments));
    }

    _createClass(SpeakerNotesOff, [{
      key: "renderSVG",
  ...
  _exports.SpeakerNotesOff = SpeakerNotesOff;
});
//# sourceMappingURL=SpeakerNotesOff.js.map