define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(EventSeat, _SvgIcon);

    function EventSeat() {
      _classCallCheck(this, EventSeat);

      return _possibleConstructorReturn(this, _getPrototypeOf(EventSeat).apply(this, arguments));
    }

    _createClass(EventSeat, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.EventSeat';
      }
    }]);
  ...
  _exports.EventSeat = EventSeat;
});
//# sourceMappingURL=EventSeat.js.map