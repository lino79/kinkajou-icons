define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SpeakerNotes, _SvgIcon);

    function SpeakerNotes() {
      _classCallCheck(this, SpeakerNotes);

      return _possibleConstructorReturn(this, _getPrototypeOf(SpeakerNotes).apply(this, arguments));
    }

    _createClass(SpeakerNotes, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.SpeakerNotes';
      }
    }]);
  ...
  _exports.SpeakerNotes = SpeakerNotes;
});
//# sourceMappingURL=SpeakerNotes.js.map