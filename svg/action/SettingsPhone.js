define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SettingsPhone, _SvgIcon);

    function SettingsPhone() {
      _classCallCheck(this, SettingsPhone);

      return _possibleConstructorReturn(this, _getPrototypeOf(SettingsPhone).apply(this, arguments));
    }
  ...
  _exports.SettingsPhone = SettingsPhone;
});
//# sourceMappingURL=SettingsPhone.js.map