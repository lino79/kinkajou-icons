define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FlightTakeoff, _SvgIcon);

    function FlightTakeoff() {
      _classCallCheck(this, FlightTakeoff);

      return _possibleConstructorReturn(this, _getPrototypeOf(FlightTakeoff).apply(this, arguments));
    }

    _createClass(FlightTakeoff, [{
      key: "renderSVG",
  ...
  _exports.FlightTakeoff = FlightTakeoff;
});
