define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AlarmOn, _SvgIcon);

    function AlarmOn() {
      _classCallCheck(this, AlarmOn);

      return _possibleConstructorReturn(this, _getPrototypeOf(AlarmOn).apply(this, arguments));
    }

    _createClass(AlarmOn, [{
      key: "renderSVG",
