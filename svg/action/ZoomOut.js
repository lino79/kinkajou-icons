define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ZoomOut, _SvgIcon);

    function ZoomOut() {
      _classCallCheck(this, ZoomOut);

      return _possibleConstructorReturn(this, _getPrototypeOf(ZoomOut).apply(this, arguments));
    }
