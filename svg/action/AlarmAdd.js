define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AlarmAdd, _SvgIcon);

    function AlarmAdd() {
      _classCallCheck(this, AlarmAdd);

      return _possibleConstructorReturn(this, _getPrototypeOf(AlarmAdd).apply(this, arguments));
    }

    _createClass(AlarmAdd, [{
      key: "renderSVG",
