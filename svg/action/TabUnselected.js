define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(TabUnselected, _SvgIcon);

    function TabUnselected() {
      _classCallCheck(this, TabUnselected);

      return _possibleConstructorReturn(this, _getPrototypeOf(TabUnselected).apply(this, arguments));
    }

    _createClass(TabUnselected, [{
      key: "renderSVG",
  ...
  _exports.TabUnselected = TabUnselected;
});
