define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PermPhoneMsg, _SvgIcon);

    function PermPhoneMsg() {
      _classCallCheck(this, PermPhoneMsg);

      return _possibleConstructorReturn(this, _getPrototypeOf(PermPhoneMsg).apply(this, arguments));
    }

    _createClass(PermPhoneMsg, [{
      key: "renderSVG",
  ...
  _exports.PermPhoneMsg = PermPhoneMsg;
});
//# sourceMappingURL=PermPhoneMsg.js.map