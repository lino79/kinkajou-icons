define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(TouchApp, _SvgIcon);

    function TouchApp() {
      _classCallCheck(this, TouchApp);

      return _possibleConstructorReturn(this, _getPrototypeOf(TouchApp).apply(this, arguments));
    }

    _createClass(TouchApp, [{
      key: "renderSVG",
  ...
  _exports.TouchApp = TouchApp;
});
//# sourceMappingURL=TouchApp.js.map