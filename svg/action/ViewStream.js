define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ViewStream, _SvgIcon);

    function ViewStream() {
      _classCallCheck(this, ViewStream);

      return _possibleConstructorReturn(this, _getPrototypeOf(ViewStream).apply(this, arguments));
    }
  ...
  _exports.ViewStream = ViewStream;
});
