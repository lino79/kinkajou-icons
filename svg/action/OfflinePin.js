define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(OfflinePin, _SvgIcon);

    function OfflinePin() {
      _classCallCheck(this, OfflinePin);

      return _possibleConstructorReturn(this, _getPrototypeOf(OfflinePin).apply(this, arguments));
    }

    _createClass(OfflinePin, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.OfflinePin';
      }
    }]);
  ...
  _exports.OfflinePin = OfflinePin;
});
//# sourceMappingURL=OfflinePin.js.map