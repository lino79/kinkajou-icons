define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Rowing, _SvgIcon);

    function Rowing() {
      _classCallCheck(this, Rowing);

      return _possibleConstructorReturn(this, _getPrototypeOf(Rowing).apply(this, arguments));
    }
  ...
  _exports.Rowing = Rowing;
});
//# sourceMappingURL=Rowing.js.map