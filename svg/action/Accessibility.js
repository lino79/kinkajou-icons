define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Accessibility, _SvgIcon);

    function Accessibility() {
      _classCallCheck(this, Accessibility);

      return _possibleConstructorReturn(this, _getPrototypeOf(Accessibility).apply(this, arguments));
    }
    ...
    _createClass(Accessibility, [{
      ...
      key: "is",
      get: function get() {
        return 'material.action.Accessibility';
      }
    }]);
  ...
  _exports.Accessibility = Accessibility;
});
