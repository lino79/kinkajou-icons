define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(RestorePage, _SvgIcon);

    function RestorePage() {
      _classCallCheck(this, RestorePage);

      return _possibleConstructorReturn(this, _getPrototypeOf(RestorePage).apply(this, arguments));
    }

    _createClass(RestorePage, [{
      key: "renderSVG",
  ...
  _exports.RestorePage = RestorePage;
});
//# sourceMappingURL=RestorePage.js.map