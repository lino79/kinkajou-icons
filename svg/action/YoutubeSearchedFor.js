define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.YoutubeSearchedFor = void 0;
  ...
  var YoutubeSearchedFor =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(YoutubeSearchedFor, _SvgIcon);

    function YoutubeSearchedFor() {
      _classCallCheck(this, YoutubeSearchedFor);

      return _possibleConstructorReturn(this, _getPrototypeOf(YoutubeSearchedFor).apply(this, arguments));
    }

    _createClass(YoutubeSearchedFor, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.YoutubeSearchedFor';
      }
    }]);
  ...
  _exports.YoutubeSearchedFor = YoutubeSearchedFor;
});
//# sourceMappingURL=YoutubeSearchedFor.js.map