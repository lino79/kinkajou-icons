define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(OpenInBrowser, _SvgIcon);

    function OpenInBrowser() {
      _classCallCheck(this, OpenInBrowser);

      return _possibleConstructorReturn(this, _getPrototypeOf(OpenInBrowser).apply(this, arguments));
    }

    _createClass(OpenInBrowser, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.OpenInBrowser';
      }
    }]);
  ...
  _exports.OpenInBrowser = OpenInBrowser;
});
