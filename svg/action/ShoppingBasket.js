define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.ShoppingBasket = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ShoppingBasket, _SvgIcon);

    function ShoppingBasket() {
      _classCallCheck(this, ShoppingBasket);

      return _possibleConstructorReturn(this, _getPrototypeOf(ShoppingBasket).apply(this, arguments));
    }
  ...
  _exports.ShoppingBasket = ShoppingBasket;
});
