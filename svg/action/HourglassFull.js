define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(HourglassFull, _SvgIcon);

    function HourglassFull() {
      _classCallCheck(this, HourglassFull);

      return _possibleConstructorReturn(this, _getPrototypeOf(HourglassFull).apply(this, arguments));
    }

    _createClass(HourglassFull, [{
      key: "renderSVG",
  ...
  _exports.HourglassFull = HourglassFull;
});
//# sourceMappingURL=HourglassFull.js.map