define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.QuestionAnswer = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(QuestionAnswer, _SvgIcon);

    function QuestionAnswer() {
      _classCallCheck(this, QuestionAnswer);

      return _possibleConstructorReturn(this, _getPrototypeOf(QuestionAnswer).apply(this, arguments));
    }
    ...
    _createClass(QuestionAnswer, [{
      ...
      key: "is",
      get: function get() {
        return 'material.action.QuestionAnswer';
      }
    }]);
  ...
  _exports.QuestionAnswer = QuestionAnswer;
});
