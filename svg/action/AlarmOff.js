define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AlarmOff, _SvgIcon);

    function AlarmOff() {
      _classCallCheck(this, AlarmOff);

      return _possibleConstructorReturn(this, _getPrototypeOf(AlarmOff).apply(this, arguments));
    }

    _createClass(AlarmOff, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.AlarmOff';
      }
    }]);
