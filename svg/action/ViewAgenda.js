define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ViewAgenda, _SvgIcon);

    function ViewAgenda() {
      _classCallCheck(this, ViewAgenda);

      return _possibleConstructorReturn(this, _getPrototypeOf(ViewAgenda).apply(this, arguments));
    }

    _createClass(ViewAgenda, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.ViewAgenda';
      }
    }]);
  ...
  _exports.ViewAgenda = ViewAgenda;
});
//# sourceMappingURL=ViewAgenda.js.map