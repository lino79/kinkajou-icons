define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Loyalty, _SvgIcon);

    function Loyalty() {
      _classCallCheck(this, Loyalty);

      return _possibleConstructorReturn(this, _getPrototypeOf(Loyalty).apply(this, arguments));
    }

    _createClass(Loyalty, [{
      key: "renderSVG",
