define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FlightLand, _SvgIcon);

    function FlightLand() {
      _classCallCheck(this, FlightLand);

      return _possibleConstructorReturn(this, _getPrototypeOf(FlightLand).apply(this, arguments));
    }

    _createClass(FlightLand, [{
      key: "renderSVG",
  ...
  _exports.FlightLand = FlightLand;
});
