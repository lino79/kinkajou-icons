define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SettingsPower, _SvgIcon);

    function SettingsPower() {
      _classCallCheck(this, SettingsPower);

      return _possibleConstructorReturn(this, _getPrototypeOf(SettingsPower).apply(this, arguments));
    }

    _createClass(SettingsPower, [{
      key: "renderSVG",
  ...
  _exports.SettingsPower = SettingsPower;
});
//# sourceMappingURL=SettingsPower.js.map