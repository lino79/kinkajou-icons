define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Gavel, _SvgIcon);

    function Gavel() {
      _classCallCheck(this, Gavel);

      return _possibleConstructorReturn(this, _getPrototypeOf(Gavel).apply(this, arguments));
    }
