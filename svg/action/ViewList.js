define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ViewList, _SvgIcon);

    function ViewList() {
      _classCallCheck(this, ViewList);

      return _possibleConstructorReturn(this, _getPrototypeOf(ViewList).apply(this, arguments));
    }
    ...
    _createClass(ViewList, [{
      ...
      key: "is",
      get: function get() {
        return 'material.action.ViewList';
      }
    }]);
