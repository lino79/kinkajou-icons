define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Announcement, _SvgIcon);

    function Announcement() {
      _classCallCheck(this, Announcement);

      return _possibleConstructorReturn(this, _getPrototypeOf(Announcement).apply(this, arguments));
    }
    ...
    _createClass(Announcement, [{
      ...
      key: "is",
      get: function get() {
        return 'material.action.Announcement';
      }
    }]);
  ...
  _exports.Announcement = Announcement;
});
