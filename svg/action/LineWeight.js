define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LineWeight, _SvgIcon);

    function LineWeight() {
      _classCallCheck(this, LineWeight);

      return _possibleConstructorReturn(this, _getPrototypeOf(LineWeight).apply(this, arguments));
    }

    _createClass(LineWeight, [{
      key: "renderSVG",
  ...
  _exports.LineWeight = LineWeight;
});
