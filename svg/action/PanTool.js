define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PanTool, _SvgIcon);

    function PanTool() {
      _classCallCheck(this, PanTool);

      return _possibleConstructorReturn(this, _getPrototypeOf(PanTool).apply(this, arguments));
    }
    ...
    _createClass(PanTool, [{
      ...
      key: "is",
      get: function get() {
        return 'material.action.PanTool';
      }
    }]);
