define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LockOutline, _SvgIcon);

    function LockOutline() {
      _classCallCheck(this, LockOutline);

      return _possibleConstructorReturn(this, _getPrototypeOf(LockOutline).apply(this, arguments));
    }

    _createClass(LockOutline, [{
      key: "renderSVG",
  ...
  _exports.LockOutline = LockOutline;
});
