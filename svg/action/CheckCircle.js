define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CheckCircle, _SvgIcon);

    function CheckCircle() {
      _classCallCheck(this, CheckCircle);

      return _possibleConstructorReturn(this, _getPrototypeOf(CheckCircle).apply(this, arguments));
    }
    ...
    _createClass(CheckCircle, [{
      ...
      key: "is",
      get: function get() {
        return 'material.action.CheckCircle';
      }
    }]);
  ...
  _exports.CheckCircle = CheckCircle;
});
