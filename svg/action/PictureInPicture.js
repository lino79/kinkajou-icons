define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.PictureInPicture = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PictureInPicture, _SvgIcon);

    function PictureInPicture() {
      _classCallCheck(this, PictureInPicture);

      return _possibleConstructorReturn(this, _getPrototypeOf(PictureInPicture).apply(this, arguments));
    }
  ...
  _exports.PictureInPicture = PictureInPicture;
});
