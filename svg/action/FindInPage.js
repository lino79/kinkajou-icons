define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FindInPage, _SvgIcon);

    function FindInPage() {
      _classCallCheck(this, FindInPage);

      return _possibleConstructorReturn(this, _getPrototypeOf(FindInPage).apply(this, arguments));
    }

    _createClass(FindInPage, [{
      key: "renderSVG",
  ...
  _exports.FindInPage = FindInPage;
});
