define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AllOut, _SvgIcon);

    function AllOut() {
      _classCallCheck(this, AllOut);

      return _possibleConstructorReturn(this, _getPrototypeOf(AllOut).apply(this, arguments));
    }
  ...
  _exports.AllOut = AllOut;
});
//# sourceMappingURL=AllOut.js.map