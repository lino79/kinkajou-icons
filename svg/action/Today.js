define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Today, _SvgIcon);

    function Today() {
      _classCallCheck(this, Today);

      return _possibleConstructorReturn(this, _getPrototypeOf(Today).apply(this, arguments));
    }
