define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Restore, _SvgIcon);

    function Restore() {
      _classCallCheck(this, Restore);

      return _possibleConstructorReturn(this, _getPrototypeOf(Restore).apply(this, arguments));
    }
