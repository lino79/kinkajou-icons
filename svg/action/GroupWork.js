define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(GroupWork, _SvgIcon);

    function GroupWork() {
      _classCallCheck(this, GroupWork);

      return _possibleConstructorReturn(this, _getPrototypeOf(GroupWork).apply(this, arguments));
    }
