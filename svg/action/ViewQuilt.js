define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ViewQuilt, _SvgIcon);

    function ViewQuilt() {
      _classCallCheck(this, ViewQuilt);

      return _possibleConstructorReturn(this, _getPrototypeOf(ViewQuilt).apply(this, arguments));
    }

    _createClass(ViewQuilt, [{
      key: "renderSVG",
