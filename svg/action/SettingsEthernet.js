define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SettingsEthernet = void 0;
  ...
  var SettingsEthernet =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SettingsEthernet, _SvgIcon);

    function SettingsEthernet() {
      _classCallCheck(this, SettingsEthernet);

      return _possibleConstructorReturn(this, _getPrototypeOf(SettingsEthernet).apply(this, arguments));
    }

    _createClass(SettingsEthernet, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.SettingsEthernet';
      }
    }]);
  ...
  _exports.SettingsEthernet = SettingsEthernet;
});
//# sourceMappingURL=SettingsEthernet.js.map