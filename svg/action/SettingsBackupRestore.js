define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SettingsBackupRestore = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SettingsBackupRestore, _SvgIcon);

    function SettingsBackupRestore() {
      _classCallCheck(this, SettingsBackupRestore);

      return _possibleConstructorReturn(this, _getPrototypeOf(SettingsBackupRestore).apply(this, arguments));
    }

    _createClass(SettingsBackupRestore, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.action.SettingsBackupRestore';
      }
    }]);
  ...
  _exports.SettingsBackupRestore = SettingsBackupRestore;
});
//# sourceMappingURL=SettingsBackupRestore.js.map