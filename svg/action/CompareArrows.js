define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CompareArrows, _SvgIcon);

    function CompareArrows() {
      _classCallCheck(this, CompareArrows);

      return _possibleConstructorReturn(this, _getPrototypeOf(CompareArrows).apply(this, arguments));
    }

    _createClass(CompareArrows, [{
      key: "renderSVG",
  ...
  _exports.CompareArrows = CompareArrows;
});
