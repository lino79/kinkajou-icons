define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BugReport, _SvgIcon);

    function BugReport() {
      _classCallCheck(this, BugReport);

      return _possibleConstructorReturn(this, _getPrototypeOf(BugReport).apply(this, arguments));
    }
