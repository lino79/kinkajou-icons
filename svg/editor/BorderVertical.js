define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.BorderVertical = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BorderVertical, _SvgIcon);

    function BorderVertical() {
      _classCallCheck(this, BorderVertical);

      return _possibleConstructorReturn(this, _getPrototypeOf(BorderVertical).apply(this, arguments));
    }

    _createClass(BorderVertical, [{
      key: "renderSVG",
...
//# sourceMappingURL=BorderVertical.js.map