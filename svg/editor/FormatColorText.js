define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.FormatColorText = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FormatColorText, _SvgIcon);

    function FormatColorText() {
      _classCallCheck(this, FormatColorText);

      return _possibleConstructorReturn(this, _getPrototypeOf(FormatColorText).apply(this, arguments));
    }

    _createClass(FormatColorText, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.editor.FormatColorText';
      }
    }]);
  ...
  _exports.FormatColorText = FormatColorText;
});
