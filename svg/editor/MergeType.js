define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(MergeType, _SvgIcon);

    function MergeType() {
      _classCallCheck(this, MergeType);

      return _possibleConstructorReturn(this, _getPrototypeOf(MergeType).apply(this, arguments));
    }

    _createClass(MergeType, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.editor.MergeType';
      }
    }]);
