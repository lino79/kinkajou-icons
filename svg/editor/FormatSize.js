define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FormatSize, _SvgIcon);

    function FormatSize() {
      _classCallCheck(this, FormatSize);

      return _possibleConstructorReturn(this, _getPrototypeOf(FormatSize).apply(this, arguments));
    }

    _createClass(FormatSize, [{
      key: "renderSVG",
