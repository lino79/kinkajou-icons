define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.StrikethroughS = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(StrikethroughS, _SvgIcon);

    function StrikethroughS() {
      _classCallCheck(this, StrikethroughS);

      return _possibleConstructorReturn(this, _getPrototypeOf(StrikethroughS).apply(this, arguments));
    }

    _createClass(StrikethroughS, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.editor.StrikethroughS';
      }
    }]);
  ...
  _exports.StrikethroughS = StrikethroughS;
});
//# sourceMappingURL=StrikethroughS.js.map