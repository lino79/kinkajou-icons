define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BorderColor, _SvgIcon);

    function BorderColor() {
      _classCallCheck(this, BorderColor);

      return _possibleConstructorReturn(this, _getPrototypeOf(BorderColor).apply(this, arguments));
    }

    _createClass(BorderColor, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.editor.BorderColor';
      }
    }]);
  ...
  _exports.BorderColor = BorderColor;
});
