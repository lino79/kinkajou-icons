define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.PieChartOutlined = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PieChartOutlined, _SvgIcon);

    function PieChartOutlined() {
      _classCallCheck(this, PieChartOutlined);

      return _possibleConstructorReturn(this, _getPrototypeOf(PieChartOutlined).apply(this, arguments));
    }

    _createClass(PieChartOutlined, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.editor.PieChartOutlined';
      }
    }]);
  ...
  _exports.PieChartOutlined = PieChartOutlined;
});
//# sourceMappingURL=PieChartOutlined.js.map