define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(TextFields, _SvgIcon);

    function TextFields() {
      _classCallCheck(this, TextFields);

      return _possibleConstructorReturn(this, _getPrototypeOf(TextFields).apply(this, arguments));
    }
  ...
  _exports.TextFields = TextFields;
});
