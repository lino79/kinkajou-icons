define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.FormatLineSpacing = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FormatLineSpacing, _SvgIcon);

    function FormatLineSpacing() {
      _classCallCheck(this, FormatLineSpacing);

      return _possibleConstructorReturn(this, _getPrototypeOf(FormatLineSpacing).apply(this, arguments));
    }

    _createClass(FormatLineSpacing, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.editor.FormatLineSpacing';
      }
    }]);
  ...
  _exports.FormatLineSpacing = FormatLineSpacing;
});
//# sourceMappingURL=FormatLineSpacing.js.map