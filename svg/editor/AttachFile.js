define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AttachFile, _SvgIcon);

    function AttachFile() {
      _classCallCheck(this, AttachFile);

      return _possibleConstructorReturn(this, _getPrototypeOf(AttachFile).apply(this, arguments));
    }
  ...
  _exports.AttachFile = AttachFile;
});
