define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FormatShapes, _SvgIcon);

    function FormatShapes() {
      _classCallCheck(this, FormatShapes);

      return _possibleConstructorReturn(this, _getPrototypeOf(FormatShapes).apply(this, arguments));
    }

    _createClass(FormatShapes, [{
      key: "renderSVG",
  ...
  _exports.FormatShapes = FormatShapes;
});
//# sourceMappingURL=FormatShapes.js.map