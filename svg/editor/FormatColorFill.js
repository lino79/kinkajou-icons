define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.FormatColorFill = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FormatColorFill, _SvgIcon);

    function FormatColorFill() {
      _classCallCheck(this, FormatColorFill);

      return _possibleConstructorReturn(this, _getPrototypeOf(FormatColorFill).apply(this, arguments));
    }

    _createClass(FormatColorFill, [{
      key: "renderSVG",
  ...
  _exports.FormatColorFill = FormatColorFill;
});
