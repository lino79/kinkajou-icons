define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BorderInner, _SvgIcon);

    function BorderInner() {
      _classCallCheck(this, BorderInner);

      return _possibleConstructorReturn(this, _getPrototypeOf(BorderInner).apply(this, arguments));
    }

    _createClass(BorderInner, [{
      key: "renderSVG",
  ...
  _exports.BorderInner = BorderInner;
});
