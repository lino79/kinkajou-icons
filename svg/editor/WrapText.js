define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(WrapText, _SvgIcon);

    function WrapText() {
      _classCallCheck(this, WrapText);

      return _possibleConstructorReturn(this, _getPrototypeOf(WrapText).apply(this, arguments));
    }
