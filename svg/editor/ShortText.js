define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ShortText, _SvgIcon);

    function ShortText() {
      _classCallCheck(this, ShortText);

      return _possibleConstructorReturn(this, _getPrototypeOf(ShortText).apply(this, arguments));
    }
