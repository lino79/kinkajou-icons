define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BorderBottom, _SvgIcon);

    function BorderBottom() {
      _classCallCheck(this, BorderBottom);

      return _possibleConstructorReturn(this, _getPrototypeOf(BorderBottom).apply(this, arguments));
    }

    _createClass(BorderBottom, [{
      key: "renderSVG",
