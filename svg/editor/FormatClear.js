define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FormatClear, _SvgIcon);

    function FormatClear() {
      _classCallCheck(this, FormatClear);

      return _possibleConstructorReturn(this, _getPrototypeOf(FormatClear).apply(this, arguments));
    }

    _createClass(FormatClear, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.editor.FormatClear';
      }
    }]);
  ...
  _exports.FormatClear = FormatClear;
});
