define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.VerticalAlignCenter = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(VerticalAlignCenter, _SvgIcon);

    function VerticalAlignCenter() {
      _classCallCheck(this, VerticalAlignCenter);

      return _possibleConstructorReturn(this, _getPrototypeOf(VerticalAlignCenter).apply(this, arguments));
    }

    _createClass(VerticalAlignCenter, [{
      key: "renderSVG",
  ...
  _exports.VerticalAlignCenter = VerticalAlignCenter;
});
