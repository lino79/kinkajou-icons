define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BorderLeft, _SvgIcon);

    function BorderLeft() {
      _classCallCheck(this, BorderLeft);

      return _possibleConstructorReturn(this, _getPrototypeOf(BorderLeft).apply(this, arguments));
    }

    _createClass(BorderLeft, [{
      key: "renderSVG",
