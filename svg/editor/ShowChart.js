define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ShowChart, _SvgIcon);

    function ShowChart() {
      _classCallCheck(this, ShowChart);

      return _possibleConstructorReturn(this, _getPrototypeOf(ShowChart).apply(this, arguments));
    }
  ...
  _exports.ShowChart = ShowChart;
});
//# sourceMappingURL=ShowChart.js.map