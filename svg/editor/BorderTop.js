define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BorderTop, _SvgIcon);

    function BorderTop() {
      _classCallCheck(this, BorderTop);

      return _possibleConstructorReturn(this, _getPrototypeOf(BorderTop).apply(this, arguments));
    }

    _createClass(BorderTop, [{
      key: "renderSVG",
