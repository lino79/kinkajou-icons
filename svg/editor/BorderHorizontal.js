define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.BorderHorizontal = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BorderHorizontal, _SvgIcon);

    function BorderHorizontal() {
      _classCallCheck(this, BorderHorizontal);

      return _possibleConstructorReturn(this, _getPrototypeOf(BorderHorizontal).apply(this, arguments));
    }

    _createClass(BorderHorizontal, [{
      key: "renderSVG",
