define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SpaceBar, _SvgIcon);

    function SpaceBar() {
      _classCallCheck(this, SpaceBar);

      return _possibleConstructorReturn(this, _getPrototypeOf(SpaceBar).apply(this, arguments));
    }

    _createClass(SpaceBar, [{
      key: "renderSVG",
