define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BorderStyle, _SvgIcon);

    function BorderStyle() {
      _classCallCheck(this, BorderStyle);

      return _possibleConstructorReturn(this, _getPrototypeOf(BorderStyle).apply(this, arguments));
    }
  ...
  _exports.BorderStyle = BorderStyle;
});
