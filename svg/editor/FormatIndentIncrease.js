define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.FormatIndentIncrease = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FormatIndentIncrease, _SvgIcon);

    function FormatIndentIncrease() {
      _classCallCheck(this, FormatIndentIncrease);

      return _possibleConstructorReturn(this, _getPrototypeOf(FormatIndentIncrease).apply(this, arguments));
    }

    _createClass(FormatIndentIncrease, [{
      key: "renderSVG",
  ...
  _exports.FormatIndentIncrease = FormatIndentIncrease;
});
