define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.FormatStrikethrough = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FormatStrikethrough, _SvgIcon);

    function FormatStrikethrough() {
      _classCallCheck(this, FormatStrikethrough);

      return _possibleConstructorReturn(this, _getPrototypeOf(FormatStrikethrough).apply(this, arguments));
    }

    _createClass(FormatStrikethrough, [{
      key: "renderSVG",
  ...
  _exports.FormatStrikethrough = FormatStrikethrough;
});
