define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(DragHandle, _SvgIcon);

    function DragHandle() {
      _classCallCheck(this, DragHandle);

      return _possibleConstructorReturn(this, _getPrototypeOf(DragHandle).apply(this, arguments));
    }
  ...
  _exports.DragHandle = DragHandle;
});
