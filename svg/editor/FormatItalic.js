define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FormatItalic, _SvgIcon);

    function FormatItalic() {
      _classCallCheck(this, FormatItalic);

      return _possibleConstructorReturn(this, _getPrototypeOf(FormatItalic).apply(this, arguments));
    }

    _createClass(FormatItalic, [{
      key: "renderSVG",
  ...
  _exports.FormatItalic = FormatItalic;
});
