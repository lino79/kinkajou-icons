define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BorderAll, _SvgIcon);

    function BorderAll() {
      _classCallCheck(this, BorderAll);

      return _possibleConstructorReturn(this, _getPrototypeOf(BorderAll).apply(this, arguments));
    }

    _createClass(BorderAll, [{
      key: "renderSVG",
