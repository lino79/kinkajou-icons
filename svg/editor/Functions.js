define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Functions, _SvgIcon);

    function Functions() {
      _classCallCheck(this, Functions);

      return _possibleConstructorReturn(this, _getPrototypeOf(Functions).apply(this, arguments));
    }
