define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.MultilineChart = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(MultilineChart, _SvgIcon);

    function MultilineChart() {
      _classCallCheck(this, MultilineChart);

      return _possibleConstructorReturn(this, _getPrototypeOf(MultilineChart).apply(this, arguments));
    }

    _createClass(MultilineChart, [{
      key: "renderSVG",
  ...
  _exports.MultilineChart = MultilineChart;
});
