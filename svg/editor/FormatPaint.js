define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FormatPaint, _SvgIcon);

    function FormatPaint() {
      _classCallCheck(this, FormatPaint);

      return _possibleConstructorReturn(this, _getPrototypeOf(FormatPaint).apply(this, arguments));
    }
    ...
    _createClass(FormatPaint, [{
      ...
      key: "is",
      get: function get() {
        return 'material.editor.FormatPaint';
      }
    }]);
  ...
  _exports.FormatPaint = FormatPaint;
});
//# sourceMappingURL=FormatPaint.js.map