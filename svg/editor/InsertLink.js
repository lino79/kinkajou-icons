define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(InsertLink, _SvgIcon);

    function InsertLink() {
      _classCallCheck(this, InsertLink);

      return _possibleConstructorReturn(this, _getPrototypeOf(InsertLink).apply(this, arguments));
    }
  ...
  _exports.InsertLink = InsertLink;
});
