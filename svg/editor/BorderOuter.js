define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BorderOuter, _SvgIcon);

    function BorderOuter() {
      _classCallCheck(this, BorderOuter);

      return _possibleConstructorReturn(this, _getPrototypeOf(BorderOuter).apply(this, arguments));
    }

    _createClass(BorderOuter, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.editor.BorderOuter';
      }
    }]);
  ...
  _exports.BorderOuter = BorderOuter;
});
