define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SwapCalls, _SvgIcon);

    function SwapCalls() {
      _classCallCheck(this, SwapCalls);

      return _possibleConstructorReturn(this, _getPrototypeOf(SwapCalls).apply(this, arguments));
    }

    _createClass(SwapCalls, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.communication.SwapCalls';
      }
    }]);
  ...
  _exports.SwapCalls = SwapCalls;
});
//# sourceMappingURL=SwapCalls.js.map