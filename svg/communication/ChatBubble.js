define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ChatBubble, _SvgIcon);

    function ChatBubble() {
      _classCallCheck(this, ChatBubble);

      return _possibleConstructorReturn(this, _getPrototypeOf(ChatBubble).apply(this, arguments));
    }
  ...
  _exports.ChatBubble = ChatBubble;
});
