define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.PhonelinkSetup = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PhonelinkSetup, _SvgIcon);

    function PhonelinkSetup() {
      _classCallCheck(this, PhonelinkSetup);

      return _possibleConstructorReturn(this, _getPrototypeOf(PhonelinkSetup).apply(this, arguments));
    }

    _createClass(PhonelinkSetup, [{
      key: "renderSVG",
  ...
  _exports.PhonelinkSetup = PhonelinkSetup;
});
//# sourceMappingURL=PhonelinkSetup.js.map