define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CallMissed, _SvgIcon);

    function CallMissed() {
      _classCallCheck(this, CallMissed);

      return _possibleConstructorReturn(this, _getPrototypeOf(CallMissed).apply(this, arguments));
    }

    _createClass(CallMissed, [{
      key: "renderSVG",
  ...
  _exports.CallMissed = CallMissed;
});
//# sourceMappingURL=CallMissed.js.map