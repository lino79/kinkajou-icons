define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PhonelinkLock, _SvgIcon);

    function PhonelinkLock() {
      _classCallCheck(this, PhonelinkLock);

      return _possibleConstructorReturn(this, _getPrototypeOf(PhonelinkLock).apply(this, arguments));
    }

    _createClass(PhonelinkLock, [{
      key: "renderSVG",
  ...
  _exports.PhonelinkLock = PhonelinkLock;
});
//# sourceMappingURL=PhonelinkLock.js.map