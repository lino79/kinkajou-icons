define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.StopScreenShare = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(StopScreenShare, _SvgIcon);

    function StopScreenShare() {
      _classCallCheck(this, StopScreenShare);

      return _possibleConstructorReturn(this, _getPrototypeOf(StopScreenShare).apply(this, arguments));
    }

    _createClass(StopScreenShare, [{
      key: "renderSVG",
  ...
  _exports.StopScreenShare = StopScreenShare;
});
