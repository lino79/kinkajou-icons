define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CallMerge, _SvgIcon);

    function CallMerge() {
      _classCallCheck(this, CallMerge);

      return _possibleConstructorReturn(this, _getPrototypeOf(CallMerge).apply(this, arguments));
    }

    _createClass(CallMerge, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.communication.CallMerge';
      }
    }]);
  ...
  _exports.CallMerge = CallMerge;
});
//# sourceMappingURL=CallMerge.js.map