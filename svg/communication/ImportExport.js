define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ImportExport, _SvgIcon);

    function ImportExport() {
      _classCallCheck(this, ImportExport);

      return _possibleConstructorReturn(this, _getPrototypeOf(ImportExport).apply(this, arguments));
    }
  ...
  _exports.ImportExport = ImportExport;
});
