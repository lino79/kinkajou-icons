define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ScreenShare, _SvgIcon);

    function ScreenShare() {
      _classCallCheck(this, ScreenShare);

      return _possibleConstructorReturn(this, _getPrototypeOf(ScreenShare).apply(this, arguments));
    }
  ...
  _exports.ScreenShare = ScreenShare;
});
