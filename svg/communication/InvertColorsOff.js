define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.InvertColorsOff = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(InvertColorsOff, _SvgIcon);

    function InvertColorsOff() {
      _classCallCheck(this, InvertColorsOff);

      return _possibleConstructorReturn(this, _getPrototypeOf(InvertColorsOff).apply(this, arguments));
    }

    _createClass(InvertColorsOff, [{
      key: "renderSVG",
  ...
  _exports.InvertColorsOff = InvertColorsOff;
});
