define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PhonelinkRing, _SvgIcon);

    function PhonelinkRing() {
      _classCallCheck(this, PhonelinkRing);

      return _possibleConstructorReturn(this, _getPrototypeOf(PhonelinkRing).apply(this, arguments));
    }

    _createClass(PhonelinkRing, [{
      key: "renderSVG",
    ...
    return PhonelinkRing;
  }(_SvgIcon2.SvgIcon);

  _exports.PhonelinkRing = PhonelinkRing;
});
//# sourceMappingURL=PhonelinkRing.js.map