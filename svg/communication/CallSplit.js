define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CallSplit, _SvgIcon);

    function CallSplit() {
      _classCallCheck(this, CallSplit);

      return _possibleConstructorReturn(this, _getPrototypeOf(CallSplit).apply(this, arguments));
    }

    _createClass(CallSplit, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.communication.CallSplit';
      }
    }]);
  ...
  _exports.CallSplit = CallSplit;
});
//# sourceMappingURL=CallSplit.js.map