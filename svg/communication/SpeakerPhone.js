define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SpeakerPhone, _SvgIcon);

    function SpeakerPhone() {
      _classCallCheck(this, SpeakerPhone);

      return _possibleConstructorReturn(this, _getPrototypeOf(SpeakerPhone).apply(this, arguments));
    }
  ...
  _exports.SpeakerPhone = SpeakerPhone;
});
