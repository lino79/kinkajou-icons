define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Dialpad, _SvgIcon);

    function Dialpad() {
      _classCallCheck(this, Dialpad);

      return _possibleConstructorReturn(this, _getPrototypeOf(Dialpad).apply(this, arguments));
    }
