define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(NoSim, _SvgIcon);

    function NoSim() {
      _classCallCheck(this, NoSim);

      return _possibleConstructorReturn(this, _getPrototypeOf(NoSim).apply(this, arguments));
    }
  ...
  _exports.NoSim = NoSim;
});
//# sourceMappingURL=NoSim.js.map