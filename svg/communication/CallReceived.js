define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CallReceived, _SvgIcon);

    function CallReceived() {
      _classCallCheck(this, CallReceived);

      return _possibleConstructorReturn(this, _getPrototypeOf(CallReceived).apply(this, arguments));
    }

    _createClass(CallReceived, [{
      key: "renderSVG",
  ...
  _exports.CallReceived = CallReceived;
});
//# sourceMappingURL=CallReceived.js.map