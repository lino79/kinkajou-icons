define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LiveHelp, _SvgIcon);

    function LiveHelp() {
      _classCallCheck(this, LiveHelp);

      return _possibleConstructorReturn(this, _getPrototypeOf(LiveHelp).apply(this, arguments));
    }

    _createClass(LiveHelp, [{
      key: "renderSVG",
  ...
  _exports.LiveHelp = LiveHelp;
});
//# sourceMappingURL=LiveHelp.js.map