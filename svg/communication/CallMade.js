define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(CallMade, _SvgIcon);

    function CallMade() {
      _classCallCheck(this, CallMade);

      return _possibleConstructorReturn(this, _getPrototypeOf(CallMade).apply(this, arguments));
    }

    _createClass(CallMade, [{
      key: "renderSVG",
  ...
  _exports.CallMade = CallMade;
});
//# sourceMappingURL=CallMade.js.map