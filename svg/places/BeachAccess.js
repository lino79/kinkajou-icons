define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BeachAccess, _SvgIcon);

    function BeachAccess() {
      _classCallCheck(this, BeachAccess);

      return _possibleConstructorReturn(this, _getPrototypeOf(BeachAccess).apply(this, arguments));
    }

    _createClass(BeachAccess, [{
      key: "renderSVG",
  ...
  _exports.BeachAccess = BeachAccess;
});
//# sourceMappingURL=BeachAccess.js.map