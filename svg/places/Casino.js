define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Casino, _SvgIcon);

    function Casino() {
      _classCallCheck(this, Casino);

      return _possibleConstructorReturn(this, _getPrototypeOf(Casino).apply(this, arguments));
    }
