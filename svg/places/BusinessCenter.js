define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.BusinessCenter = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BusinessCenter, _SvgIcon);

    function BusinessCenter() {
      _classCallCheck(this, BusinessCenter);

      return _possibleConstructorReturn(this, _getPrototypeOf(BusinessCenter).apply(this, arguments));
    }
  ...
  _exports.BusinessCenter = BusinessCenter;
});
//# sourceMappingURL=BusinessCenter.js.map