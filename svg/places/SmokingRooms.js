define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SmokingRooms, _SvgIcon);

    function SmokingRooms() {
      _classCallCheck(this, SmokingRooms);

      return _possibleConstructorReturn(this, _getPrototypeOf(SmokingRooms).apply(this, arguments));
    }

    _createClass(SmokingRooms, [{
      key: "renderSVG",
  ...
  _exports.SmokingRooms = SmokingRooms;
});
//# sourceMappingURL=SmokingRooms.js.map