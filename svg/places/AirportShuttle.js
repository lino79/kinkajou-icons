define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.AirportShuttle = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AirportShuttle, _SvgIcon);

    function AirportShuttle() {
      _classCallCheck(this, AirportShuttle);

      return _possibleConstructorReturn(this, _getPrototypeOf(AirportShuttle).apply(this, arguments));
    }

    _createClass(AirportShuttle, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.places.AirportShuttle';
      }
    }]);
  ...
  _exports.AirportShuttle = AirportShuttle;
});
//# sourceMappingURL=AirportShuttle.js.map