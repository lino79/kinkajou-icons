define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SmokeFree, _SvgIcon);

    function SmokeFree() {
      _classCallCheck(this, SmokeFree);

      return _possibleConstructorReturn(this, _getPrototypeOf(SmokeFree).apply(this, arguments));
    }

    _createClass(SmokeFree, [{
      key: "renderSVG",
