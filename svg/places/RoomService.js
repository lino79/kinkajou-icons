define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(RoomService, _SvgIcon);

    function RoomService() {
      _classCallCheck(this, RoomService);

      return _possibleConstructorReturn(this, _getPrototypeOf(RoomService).apply(this, arguments));
    }
  ...
  _exports.RoomService = RoomService;
});
