define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(FitnessCenter, _SvgIcon);

    function FitnessCenter() {
      _classCallCheck(this, FitnessCenter);

      return _possibleConstructorReturn(this, _getPrototypeOf(FitnessCenter).apply(this, arguments));
    }

    _createClass(FitnessCenter, [{
      key: "renderSVG",
  ...
  _exports.FitnessCenter = FitnessCenter;
});
