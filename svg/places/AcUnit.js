define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AcUnit, _SvgIcon);

    function AcUnit() {
      _classCallCheck(this, AcUnit);

      return _possibleConstructorReturn(this, _getPrototypeOf(AcUnit).apply(this, arguments));
    }
  ...
  _exports.AcUnit = AcUnit;
});
//# sourceMappingURL=AcUnit.js.map