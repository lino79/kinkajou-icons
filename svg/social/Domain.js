define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Domain, _SvgIcon);

    function Domain() {
      _classCallCheck(this, Domain);

      return _possibleConstructorReturn(this, _getPrototypeOf(Domain).apply(this, arguments));
    }
