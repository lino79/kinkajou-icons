define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SentimentVerySatisfied = void 0;
  ...
  var SentimentVerySatisfied =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SentimentVerySatisfied, _SvgIcon);

    function SentimentVerySatisfied() {
      _classCallCheck(this, SentimentVerySatisfied);

      return _possibleConstructorReturn(this, _getPrototypeOf(SentimentVerySatisfied).apply(this, arguments));
    }

    _createClass(SentimentVerySatisfied, [{
      key: "renderSVG",
  ...
  _exports.SentimentVerySatisfied = SentimentVerySatisfied;
});
//# sourceMappingURL=SentimentVerySatisfied.js.map