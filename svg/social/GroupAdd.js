define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(GroupAdd, _SvgIcon);

    function GroupAdd() {
      _classCallCheck(this, GroupAdd);

      return _possibleConstructorReturn(this, _getPrototypeOf(GroupAdd).apply(this, arguments));
    }
