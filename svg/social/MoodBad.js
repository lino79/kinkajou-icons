define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(MoodBad, _SvgIcon);

    function MoodBad() {
      _classCallCheck(this, MoodBad);

      return _possibleConstructorReturn(this, _getPrototypeOf(MoodBad).apply(this, arguments));
    }

    _createClass(MoodBad, [{
      key: "renderSVG",
