define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Cake, _SvgIcon);

    function Cake() {
      _classCallCheck(this, Cake);

      return _possibleConstructorReturn(this, _getPrototypeOf(Cake).apply(this, arguments));
    }
