define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.NotificationsPaused = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(NotificationsPaused, _SvgIcon);

    function NotificationsPaused() {
      _classCallCheck(this, NotificationsPaused);

      return _possibleConstructorReturn(this, _getPrototypeOf(NotificationsPaused).apply(this, arguments));
    }

    _createClass(NotificationsPaused, [{
      key: "renderSVG",
  ...
  _exports.NotificationsPaused = NotificationsPaused;
});
