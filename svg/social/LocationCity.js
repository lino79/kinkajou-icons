define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LocationCity, _SvgIcon);

    function LocationCity() {
      _classCallCheck(this, LocationCity);

      return _possibleConstructorReturn(this, _getPrototypeOf(LocationCity).apply(this, arguments));
    }

    _createClass(LocationCity, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.social.LocationCity';
      }
    }]);
  ...
  _exports.LocationCity = LocationCity;
});
//# sourceMappingURL=LocationCity.js.map