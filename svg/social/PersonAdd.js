define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PersonAdd, _SvgIcon);

    function PersonAdd() {
      _classCallCheck(this, PersonAdd);

      return _possibleConstructorReturn(this, _getPrototypeOf(PersonAdd).apply(this, arguments));
    }
