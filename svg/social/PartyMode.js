define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PartyMode, _SvgIcon);

    function PartyMode() {
      _classCallCheck(this, PartyMode);

      return _possibleConstructorReturn(this, _getPrototypeOf(PartyMode).apply(this, arguments));
    }

    _createClass(PartyMode, [{
      key: "renderSVG",
  ...
  _exports.PartyMode = PartyMode;
});
//# sourceMappingURL=PartyMode.js.map