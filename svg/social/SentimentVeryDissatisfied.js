define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SentimentVeryDissatisfied = void 0;
  ...
  var SentimentVeryDissatisfied =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SentimentVeryDissatisfied, _SvgIcon);

    function SentimentVeryDissatisfied() {
      _classCallCheck(this, SentimentVeryDissatisfied);

      return _possibleConstructorReturn(this, _getPrototypeOf(SentimentVeryDissatisfied).apply(this, arguments));
    }

    _createClass(SentimentVeryDissatisfied, [{
      key: "renderSVG",
  ...
  _exports.SentimentVeryDissatisfied = SentimentVeryDissatisfied;
});
//# sourceMappingURL=SentimentVeryDissatisfied.js.map