define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(PlusOne, _SvgIcon);

    function PlusOne() {
      _classCallCheck(this, PlusOne);

      return _possibleConstructorReturn(this, _getPrototypeOf(PlusOne).apply(this, arguments));
    }

    _createClass(PlusOne, [{
      key: "renderSVG",
