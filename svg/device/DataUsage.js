define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(DataUsage, _SvgIcon);

    function DataUsage() {
      _classCallCheck(this, DataUsage);

      return _possibleConstructorReturn(this, _getPrototypeOf(DataUsage).apply(this, arguments));
    }

    _createClass(DataUsage, [{
      key: "renderSVG",
  ...
  _exports.DataUsage = DataUsage;
});
//# sourceMappingURL=DataUsage.js.map