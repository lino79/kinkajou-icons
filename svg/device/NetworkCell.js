define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(NetworkCell, _SvgIcon);

    function NetworkCell() {
      _classCallCheck(this, NetworkCell);

      return _possibleConstructorReturn(this, _getPrototypeOf(NetworkCell).apply(this, arguments));
    }

    _createClass(NetworkCell, [{
      key: "renderSVG",
  ...
  _exports.NetworkCell = NetworkCell;
});
