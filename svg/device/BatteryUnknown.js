define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.BatteryUnknown = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BatteryUnknown, _SvgIcon);

    function BatteryUnknown() {
      _classCallCheck(this, BatteryUnknown);

      return _possibleConstructorReturn(this, _getPrototypeOf(BatteryUnknown).apply(this, arguments));
    }

    _createClass(BatteryUnknown, [{
      key: "renderSVG",
  ...
  _exports.BatteryUnknown = BatteryUnknown;
});
