define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SignalWifi1Bar = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SignalWifi1Bar, _SvgIcon);

    function SignalWifi1Bar() {
      _classCallCheck(this, SignalWifi1Bar);

      return _possibleConstructorReturn(this, _getPrototypeOf(SignalWifi1Bar).apply(this, arguments));
    }

    _createClass(SignalWifi1Bar, [{
      key: "renderSVG",
  ...
  _exports.SignalWifi1Bar = SignalWifi1Bar;
});
//# sourceMappingURL=SignalWifi1Bar.js.map