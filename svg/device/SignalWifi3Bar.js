define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SignalWifi3Bar = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SignalWifi3Bar, _SvgIcon);

    function SignalWifi3Bar() {
      _classCallCheck(this, SignalWifi3Bar);

      return _possibleConstructorReturn(this, _getPrototypeOf(SignalWifi3Bar).apply(this, arguments));
    }

    _createClass(SignalWifi3Bar, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.device.SignalWifi3Bar';
      }
    }]);
  ...
  _exports.SignalWifi3Bar = SignalWifi3Bar;
});
//# sourceMappingURL=SignalWifi3Bar.js.map