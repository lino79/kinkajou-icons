define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.LocationSearching = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(LocationSearching, _SvgIcon);

    function LocationSearching() {
      _classCallCheck(this, LocationSearching);

      return _possibleConstructorReturn(this, _getPrototypeOf(LocationSearching).apply(this, arguments));
    }

    _createClass(LocationSearching, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.device.LocationSearching';
      }
    }]);
  ...
  _exports.LocationSearching = LocationSearching;
});
//# sourceMappingURL=LocationSearching.js.map