define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SettingsSystemDaydream = void 0;
  ...
  var SettingsSystemDaydream =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SettingsSystemDaydream, _SvgIcon);

    function SettingsSystemDaydream() {
      _classCallCheck(this, SettingsSystemDaydream);

      return _possibleConstructorReturn(this, _getPrototypeOf(SettingsSystemDaydream).apply(this, arguments));
    }

    _createClass(SettingsSystemDaydream, [{
      key: "renderSVG",
  ...
  _exports.SettingsSystemDaydream = SettingsSystemDaydream;
});
//# sourceMappingURL=SettingsSystemDaydream.js.map