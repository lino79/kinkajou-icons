define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SignalWifi1BarLock = void 0;
  ...
  var SignalWifi1BarLock =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SignalWifi1BarLock, _SvgIcon);

    function SignalWifi1BarLock() {
      _classCallCheck(this, SignalWifi1BarLock);

      return _possibleConstructorReturn(this, _getPrototypeOf(SignalWifi1BarLock).apply(this, arguments));
    }

    _createClass(SignalWifi1BarLock, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.device.SignalWifi1BarLock';
      }
    }]);

    return SignalWifi1BarLock;
  }(_SvgIcon2.SvgIcon);

  _exports.SignalWifi1BarLock = SignalWifi1BarLock;
});
//# sourceMappingURL=SignalWifi1BarLock.js.map