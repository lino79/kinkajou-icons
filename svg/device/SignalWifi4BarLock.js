define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SignalWifi4BarLock = void 0;
  ...
  var SignalWifi4BarLock =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SignalWifi4BarLock, _SvgIcon);

    function SignalWifi4BarLock() {
      _classCallCheck(this, SignalWifi4BarLock);

      return _possibleConstructorReturn(this, _getPrototypeOf(SignalWifi4BarLock).apply(this, arguments));
    }

    _createClass(SignalWifi4BarLock, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.device.SignalWifi4BarLock';
      }
    }]);

    return SignalWifi4BarLock;
  }(_SvgIcon2.SvgIcon);

  _exports.SignalWifi4BarLock = SignalWifi4BarLock;
});
//# sourceMappingURL=SignalWifi4BarLock.js.map