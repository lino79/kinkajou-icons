define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(NetworkWifi, _SvgIcon);

    function NetworkWifi() {
      _classCallCheck(this, NetworkWifi);

      return _possibleConstructorReturn(this, _getPrototypeOf(NetworkWifi).apply(this, arguments));
    }

    _createClass(NetworkWifi, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.device.NetworkWifi';
      }
    }]);
  ...
  _exports.NetworkWifi = NetworkWifi;
});
//# sourceMappingURL=NetworkWifi.js.map