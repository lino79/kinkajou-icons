define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.ScreenLockPortrait = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ScreenLockPortrait, _SvgIcon);

    function ScreenLockPortrait() {
      _classCallCheck(this, ScreenLockPortrait);

      return _possibleConstructorReturn(this, _getPrototypeOf(ScreenLockPortrait).apply(this, arguments));
    }

    _createClass(ScreenLockPortrait, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.device.ScreenLockPortrait';
      }
    }]);

    return ScreenLockPortrait;
  }(_SvgIcon2.SvgIcon);

  _exports.ScreenLockPortrait = ScreenLockPortrait;
});
//# sourceMappingURL=ScreenLockPortrait.js.map