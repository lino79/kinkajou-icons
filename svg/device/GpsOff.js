define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(GpsOff, _SvgIcon);

    function GpsOff() {
      _classCallCheck(this, GpsOff);

      return _possibleConstructorReturn(this, _getPrototypeOf(GpsOff).apply(this, arguments));
    }
