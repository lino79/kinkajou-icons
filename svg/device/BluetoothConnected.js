define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.BluetoothConnected = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BluetoothConnected, _SvgIcon);

    function BluetoothConnected() {
      _classCallCheck(this, BluetoothConnected);

      return _possibleConstructorReturn(this, _getPrototypeOf(BluetoothConnected).apply(this, arguments));
    }

    _createClass(BluetoothConnected, [{
      key: "renderSVG",
  ...
  _exports.BluetoothConnected = BluetoothConnected;
});
