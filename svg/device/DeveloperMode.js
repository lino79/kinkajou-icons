define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(DeveloperMode, _SvgIcon);

    function DeveloperMode() {
      _classCallCheck(this, DeveloperMode);

      return _possibleConstructorReturn(this, _getPrototypeOf(DeveloperMode).apply(this, arguments));
    }

    _createClass(DeveloperMode, [{
      key: "renderSVG",
  ...
  _exports.DeveloperMode = DeveloperMode;
});
