define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(Bluetooth, _SvgIcon);

    function Bluetooth() {
      _classCallCheck(this, Bluetooth);

      return _possibleConstructorReturn(this, _getPrototypeOf(Bluetooth).apply(this, arguments));
    }
