define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BatteryFull, _SvgIcon);

    function BatteryFull() {
      _classCallCheck(this, BatteryFull);

      return _possibleConstructorReturn(this, _getPrototypeOf(BatteryFull).apply(this, arguments));
    }
  ...
  _exports.BatteryFull = BatteryFull;
});
