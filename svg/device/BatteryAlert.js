define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BatteryAlert, _SvgIcon);

    function BatteryAlert() {
      _classCallCheck(this, BatteryAlert);

      return _possibleConstructorReturn(this, _getPrototypeOf(BatteryAlert).apply(this, arguments));
    }

    _createClass(BatteryAlert, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.device.BatteryAlert';
      }
    }]);
  ...
  _exports.BatteryAlert = BatteryAlert;
});
