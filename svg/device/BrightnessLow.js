define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BrightnessLow, _SvgIcon);

    function BrightnessLow() {
      _classCallCheck(this, BrightnessLow);

      return _possibleConstructorReturn(this, _getPrototypeOf(BrightnessLow).apply(this, arguments));
    }

    _createClass(BrightnessLow, [{
      key: "renderSVG",
  ...
  _exports.BrightnessLow = BrightnessLow;
});
