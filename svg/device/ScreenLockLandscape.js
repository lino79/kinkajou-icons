define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.ScreenLockLandscape = void 0;
  ...
  var ScreenLockLandscape =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(ScreenLockLandscape, _SvgIcon);

    function ScreenLockLandscape() {
      _classCallCheck(this, ScreenLockLandscape);

      return _possibleConstructorReturn(this, _getPrototypeOf(ScreenLockLandscape).apply(this, arguments));
    }

    _createClass(ScreenLockLandscape, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.device.ScreenLockLandscape';
      }
    }]);
  ...
  _exports.ScreenLockLandscape = ScreenLockLandscape;
});
//# sourceMappingURL=ScreenLockLandscape.js.map