define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SignalWifi0Bar = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SignalWifi0Bar, _SvgIcon);

    function SignalWifi0Bar() {
      _classCallCheck(this, SignalWifi0Bar);

      return _possibleConstructorReturn(this, _getPrototypeOf(SignalWifi0Bar).apply(this, arguments));
    }

    _createClass(SignalWifi0Bar, [{
      key: "renderSVG",
  ...
  _exports.SignalWifi0Bar = SignalWifi0Bar;
});
//# sourceMappingURL=SignalWifi0Bar.js.map