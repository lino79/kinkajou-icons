define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.BluetoothSearching = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BluetoothSearching, _SvgIcon);

    function BluetoothSearching() {
      _classCallCheck(this, BluetoothSearching);

      return _possibleConstructorReturn(this, _getPrototypeOf(BluetoothSearching).apply(this, arguments));
    }

    _createClass(BluetoothSearching, [{
      key: "renderSVG",
  ...
  _exports.BluetoothSearching = BluetoothSearching;
});
