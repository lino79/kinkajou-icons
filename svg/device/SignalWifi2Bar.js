define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SignalWifi2Bar = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SignalWifi2Bar, _SvgIcon);

    function SignalWifi2Bar() {
      _classCallCheck(this, SignalWifi2Bar);

      return _possibleConstructorReturn(this, _getPrototypeOf(SignalWifi2Bar).apply(this, arguments));
    }

    _createClass(SignalWifi2Bar, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.device.SignalWifi2Bar';
      }
    }]);
  ...
  _exports.SignalWifi2Bar = SignalWifi2Bar;
});
//# sourceMappingURL=SignalWifi2Bar.js.map