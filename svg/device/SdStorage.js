define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SdStorage, _SvgIcon);

    function SdStorage() {
      _classCallCheck(this, SdStorage);

      return _possibleConstructorReturn(this, _getPrototypeOf(SdStorage).apply(this, arguments));
    }

    _createClass(SdStorage, [{
      key: "renderSVG",
  ...
  _exports.SdStorage = SdStorage;
});
//# sourceMappingURL=SdStorage.js.map