define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.BluetoothDisabled = void 0;
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(BluetoothDisabled, _SvgIcon);

    function BluetoothDisabled() {
      _classCallCheck(this, BluetoothDisabled);

      return _possibleConstructorReturn(this, _getPrototypeOf(BluetoothDisabled).apply(this, arguments));
    }

    _createClass(BluetoothDisabled, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.device.BluetoothDisabled';
      }
    }]);
  ...
  _exports.BluetoothDisabled = BluetoothDisabled;
});
//# sourceMappingURL=BluetoothDisabled.js.map