define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AccessAlarm, _SvgIcon);

    function AccessAlarm() {
      _classCallCheck(this, AccessAlarm);

      return _possibleConstructorReturn(this, _getPrototypeOf(AccessAlarm).apply(this, arguments));
    }

    _createClass(AccessAlarm, [{
      key: "renderSVG",
  ...
  _exports.AccessAlarm = AccessAlarm;
});
