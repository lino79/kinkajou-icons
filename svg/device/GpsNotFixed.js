define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(GpsNotFixed, _SvgIcon);

    function GpsNotFixed() {
      _classCallCheck(this, GpsNotFixed);

      return _possibleConstructorReturn(this, _getPrototypeOf(GpsNotFixed).apply(this, arguments));
    }

    _createClass(GpsNotFixed, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.device.GpsNotFixed';
      }
    }]);
  ...
  _exports.GpsNotFixed = GpsNotFixed;
});
//# sourceMappingURL=GpsNotFixed.js.map