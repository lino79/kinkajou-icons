define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(WifiLock, _SvgIcon);

    function WifiLock() {
      _classCallCheck(this, WifiLock);

      return _possibleConstructorReturn(this, _getPrototypeOf(WifiLock).apply(this, arguments));
    }

    _createClass(WifiLock, [{
      key: "renderSVG",
