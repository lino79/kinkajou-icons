define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AccessAlarms, _SvgIcon);

    function AccessAlarms() {
      _classCallCheck(this, AccessAlarms);

      return _possibleConstructorReturn(this, _getPrototypeOf(AccessAlarms).apply(this, arguments));
    }

    _createClass(AccessAlarms, [{
      key: "renderSVG",
      ...
      key: "is",
      get: function get() {
        return 'material.device.AccessAlarms';
      }
    }]);
  ...
  _exports.AccessAlarms = AccessAlarms;
});
//# sourceMappingURL=AccessAlarms.js.map