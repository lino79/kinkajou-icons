define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(AddAlarm, _SvgIcon);

    function AddAlarm() {
      _classCallCheck(this, AddAlarm);

      return _possibleConstructorReturn(this, _getPrototypeOf(AddAlarm).apply(this, arguments));
    }

    _createClass(AddAlarm, [{
      key: "renderSVG",
