define(["exports", "@kinkajou/kinkajou/Kinkajou", "@kinkajou/svg-icon/SvgIcon"], function (_exports, _Kinkajou, _SvgIcon2) {
  ...
  _exports.SignalWifi2BarLock = void 0;
  ...
  var SignalWifi2BarLock =
  /*#__PURE__*/
  function (_SvgIcon) {
    _inherits(SignalWifi2BarLock, _SvgIcon);

    function SignalWifi2BarLock() {
      _classCallCheck(this, SignalWifi2BarLock);

      return _possibleConstructorReturn(this, _getPrototypeOf(SignalWifi2BarLock).apply(this, arguments));
    }

    _createClass(SignalWifi2BarLock, [{
      key: "renderSVG",
  ...
  _exports.SignalWifi2BarLock = SignalWifi2BarLock;
});
//# sourceMappingURL=SignalWifi2BarLock.js.map